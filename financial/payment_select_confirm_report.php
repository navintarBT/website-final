                        ...
                        <div class="collapse navbar-collapse justify-content-between">
                            <div class="header-left">
                                <div class="dashboard_bar">
                                    ລາຍງານຂໍ້ມູນການຢຶນຢັນຂອງການເງິນ
                                </div>
                            </div>
            ...
            <div class="content-body ">
                <div class="container-fluid">
                    ...
                    <div class="row page-titles">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active"><a href="javascript:void(0)"></a>ລາຍງານຂໍ້ມູນການການຢືນຢັນຊຳລະຄ່າງວດ</li>
                                    ...
                                    <div class="card-body p-4">
                                        <div class="media">
                                            ...
                                            <div class="media-body text-white">
                                                <p class="mb-1 fs-18">ຈຳນວນການຢືນຢັນຊຳລະຄ່າງວດພາຍໃນມື້ນີ້</p>
                                ...
                                <div class="widget-stat card bg-danger">
                                    <div class="card-body  p-4">
                                        <div class="media">
                                            ...
                                            <div class="media-body text-white">
                                                <p class="mb-1 fs-18">ຈຳນວນການຢືນຢັນຊຳລະຄ່າງວດພາຍໃນອະທິດນີ້</p>
                                ...
                                <div class="widget-stat card bg-warning">
                                    <div class="card-body p-4">
                                        <div class="media">
                                            ...
                                            <div class="media-body text-white">
                                                <p class="mb-1 fs-18">ຈຳນວນການຢືນຢັນຊຳລະຄ່າງວດພາຍໃນເດືອນນີ້</p>
                                ...
                                <div class="widget-stat card bg-secondary">
                                    <div class="card-body p-4">
                                        <div class="media">
                                            ...
                                            <div class="media-body text-white">
                                                <p class="mb-1 fs-18">ຈຳນວນການຢືນຢັນຊຳລະຄ່າງວດພາຍໃນປີນີ້</p>
                            ...
                            <a href="payment_select.php">
                                <div style="height: 290px;" class="card-bx bg-dark-blue">
                                    ...
                                    <div class="card-info text-white">
                                        ...
                                        <p class="fs-18">ຈຳນວນການການຢືນຢັນຊຳລະທັງໝົດ</p>
