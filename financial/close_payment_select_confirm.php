                                                        ...
                                                        <td>
                                                            <div class="btn-group dropstart mb-1">
                                                                ...
                                                                <div style="background: #FDFEFE;" class="dropdown-menu">
                                                                    <center>
                                                                        <p style="margin-top: 5px; margin-bottom: -5px; margin-right: 5px;">ເມນູ</p>payment_more.php
                                                                    </center>
                                                                    <hr>

                                                                    <a class="dropdown-item" href="payment_more.php?id=<?php echo $row['pm_id']; ?>">ເບິ່ງຂໍ້ມູນເພີ້ມຕື່ມ</a>
                                                                    <a class="dropdown-item" href="payment_more_confirm.php?id=<?php echo $row['pm_id']; ?>">ຢືນຢັນການຈ່າຍຄ່າງວດ</a>
                                                                    <hr>
                                                                </div>
                                                            </div>
                                                        </td>
