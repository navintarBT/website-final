                            ...
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white text-end">
                                        ...
                                        <h3 class="text-white">
                                            <?php echo number_format($show_expense) ?> ກີບ
                                        </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white text-end">
                                        ...
                                        <h3 class="text-white">
                                            <?php echo number_format($show_expensesmin) ?> ກີບ
                                        </h3>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="collateral_insert_car.php" style="cursor: pointer;"
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($users as $row) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $row['car_running_id']; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row['car_check_name']; ?>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <?php echo $row['car_eg_number']; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row['car_t_number']; ?>
                                                    </td>
                                                    <td>
                                                        ...
                                                        <div class="btn-group dropstart mb-1">
                                                            ...
                                                            <div style="background: #FDFEFE;" class="dropdown-menu">
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="collateral_more_car.php?id=<?php echo $row['car_id']; ?>">ເບິ່ງຂໍ້ມູນເພີ້ມຕື່ມ</a>
                                                                <a class="dropdown-item"
                                                                    href="collateral_docs_car/<?php echo $row['car_doc_file']; ?>">ໃບລາຍງານການກົດສອບຊັບສົມບັດ</a>
                                                                <hr>
                                                                <a class="dropdown-item button_edit"
                                                                    href="collateral_update_car.php?id=<?php echo $row['car_id']; ?>">ແກ້ໄຂຂໍ້ມູນ</a>
                                                                <a data-car_id="<?= $row['car_id']; ?>"
                                                                    href="?delete=<?= $row['car_id']; ?>"
