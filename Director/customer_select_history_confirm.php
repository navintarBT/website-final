                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            <div class="dashboard_bar">
                                ລາຍງານຂໍ້ມູນການຢືນຢັນຂອງເຄົາເຕີ
                            </div>
                        </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">ລາຍງານຂໍ້ມູນການຢືນຢັນລູກຄ້າທັງໝົດ</a></li>
                    </ol>
                </div>
                <!-- row -->
                            ...
                            <div class="card bg-warning invoice-card">
                                <div class="card-body d-flex">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-white fs-18">ລູກຄ້າທີ່ຢືນຢັນທັງໝົດ</span>
                                    </div>
                                </div>
                            </div>
                        </a>
                            ...
                            <div class="card bg-success invoice-card">
                                <div class="card-body d-flex">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-white fs-18">ລູກຄ້າທີ່ບໍ່ໄດ້ຢືນຢັນ</span>
                                    </div>
                                </div>
                            </div>
                        </a>
                            ...
                            <div class="card bg-info invoice-card">
                                <div class="card-body d-flex">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-white fs-18">ລູກຄ້າທີ່ຢືນຢັນແລ້ວ</span>
                                    </div>
                                </div>
                            </div>
                        </a>
                            ...
                            <div class="card bg-secondary invoice-card">
                                <div class="card-body d-flex">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-white fs-18">ລູກຄ້າທີ່ຖ້າການຢືນຢັນ</span>
                                    </div>
                                </div>
                            </div>
                        </a>
                                ...
                                <div class="card-body p-4">
                                    <div class="media">
                                        ...
                                        <div class="media-body text-white">
                                            <p class="mb-1 fs-18">ຈຳນວນລູກຄ້າທີ່ຢືນຢັນພາຍໃນມື້ນີ້</p>
                            ...
                            <div class="widget-stat card bg-danger">
                                <div class="card-body  p-4">
                                    <div class="media">
                                        ...
                                        <div class="media-body text-white">
                                            <p class="mb-1 fs-18">ຈຳນວນລູກຄ້າທີ່ຢືນຢັນພາຍໃນອະທິດນີ້</p>
                            ...
                            <div class="widget-stat card bg-warning">
                                <div class="card-body p-4">
                                    <div class="media">
                                        ...
                                        <div class="media-body text-white">
                                            <p class="mb-1 fs-18">ຈຳນວນລູກຄ້າທີ່ຢືນຢັນພາຍໃນເດືອນນີ້</p>
                            ...
                            <div class="widget-stat card bg-secondary">
                                <div class="card-body p-4">
                                    <div class="media">
                                        ...
                                        <div class="media-body text-white">
                                            <p class="mb-1 fs-18">ຈຳນວນລູກຄ້າທີ່ຢືນຢັນພາຍໃນປີນີ້</p>
