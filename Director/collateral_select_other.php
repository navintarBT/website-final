                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a
                                href="javascript:void(0)"></a>ລາຍງານຂໍ້ມູນຫຼັບຊັບຄ້ຳປະກັນອື່ນໆ</li>
                    </ol>
                </div>
                <!-- row -->
                            ...
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white text-end">
                                        ...
                                        <h3 class="text-white">
                                            <?php echo number_format($shohw_total_income_max) ?> ກີບ
                                        </h3>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="collateral_insert_other.php" style="cursor: pointer;"
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($users as $row) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $row['ot_runing_id']; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row['ot_other']; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row['ot_name']; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row['ot_date']; ?>,
                                                        <?php echo $row['ot_time']; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo number_format($row['ot_original_price']); ?> LAK
                                                    </td>
                                                    <td>
                                                        <?php echo number_format($row['ot_market_price']); ?> LAK
                                                    </td>
                                                    <td>
                                                        <?php echo number_format($row['ot_pham']); ?> LAK
                                                    </td>
                                                    <td>
                                                        <?php echo $row['ot_date_in']; ?>
                                                    </td>
                                                    <td>
                                                        <?php
                                                        if ($row['ot_status'] == 0) {
                                                        ...
                                                        <div class="btn-group dropstart mb-1">
                                                            ...
                                                            <div style="background: #FDFEFE;" class="dropdown-menu">
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="collateral_more_other.php?id=<?php echo $row['ot_id']; ?>">ເບິ່ງຂໍ້ມູນເພີ້ມຕື່ມ</a>
                                                                <a class="dropdown-item"
