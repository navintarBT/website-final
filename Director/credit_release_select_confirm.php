        ...
        <div class="content-body ">
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a href="javascript:void(0)"></a>ການຢືນຢັນປ່ອຍສິນເຊື່ອ</li>
                        <li class="breadcrumb-item"><a href="javascript:void(0)">ລາຍງານຂໍ້ມູນການຢືນຢັນປ່ອຍສິນເຊື່ອ</a></li>
                    </ol>
                </div>
                <!-- row -->
                            ...
                            <div class="card-body d-flex">
                                ...
                                <div>
                                    <h2 class="text-white invoice-num">
                                        <?php echo $show_count_lg_id[0] ?> ລາຍການ
                                    </h2>
                                    <span class="text-white fs-18">ຈຳນວນການຢືນຢັນປ່ອຍສິນເຊື່ອທັງໝົດ</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-xxl-3 col-sm-6">
                        <div class="card bg-success invoice-card">
                            <div class="card-body d-flex">
                                ...
                                <div>
                                    <h2 class="text-white invoice-num">
                                        <?php echo $show_count_la_status0[0] ?> ລາຍການ
                                    </h2>
                                    <span class="text-white fs-18">ຈຳນວນການຢືນຢັນສິນເຊື່ອຜ່ອນຊຳລະ</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-xxl-3 col-sm-6">
                        <div class="card bg-info invoice-card">
                            <div class="card-body d-flex">
                                ...
                                <div>
                                    <h2 class="text-white invoice-num">
                                        <?php echo $show_count_la_status1[0] ?> ລາຍການ
                                    </h2>
                                    <span class="text-white fs-18">ຈຳນວນການຢືນຢັນສິນເຊື່ອປິດສັນຍາແລ້ວ</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card bg-success invoice-card">
                            <div class="card-body d-flex">
                                ...
                                <div>
                                    ...
                                    <span class="text-white fs-18">ຈຳນວນສິນເຊື່ອທີ່ຖ້າການຢືນຢັນ</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-body p-4">
                                    <div class="media">
                                        ...
                                        <div class="media-body text-white">
                                            <p class="mb-1 fs-18">ຈຳນວນການຢືນຢັນປ່ອຍສິນເຊື່ອພາຍໃນມື້ນີ້</p>
                                            <h4 class="text-white">
                                                <?php echo $show_count_cus_date_in[0] ?> ລາຍການ
                                            </h4>
                                            <p class="mb-1 fs-18">ລວມເປັນເງິນ</p>
                                            <h4 class="text-white">
                                                <?php echo number_format($show_sum_pm_pcp_itr[0]) ?> ກີບ
                                            </h4>
                                            <small>
                            ...
                            <div class="widget-stat card bg-danger">
                                <div class="card-body  p-4">
                                    <div class="media">
                                        ...
                                        <div class="media-body text-white">
                                            <p class="mb-1 fs-18">ຈຳນວນການຢືນຢັນປ່ອຍສິນເຊື່ອພາຍໃນອະທິດນີ້</p>
                                            <h4 class="text-white">
                                                <?php echo $show_count_cus_date_in_week[0] ?> ລາຍການ
                                            </h4>
                                            <p class="mb-1 fs-18">ລວມເປັນເງິນ</p>
                                            <h4 class="text-white">
                                                <?php echo number_format($show_sum_pm_pcp_itr_week[0]); ?> ກີບ
                                            </h4>
                                            <small>
                            ...
                            <div class="widget-stat card bg-warning">
                                <div class="card-body p-4">
                                    <div class="media">
                                        ...
                                        <div class="media-body text-white">
                                            <p class="mb-1 fs-18">ຈຳນວນການຢືນຢັນປ່ອຍສິນເຊື່ອພາຍໃນເດືອນນີ້</p>
                                            <h4 class="text-white">
                                                <?php echo $show_count_cus_date_in_month[0] ?> ລາຍການ
                                            </h4>
                                            <p class="mb-1 fs-18">ລວມເປັນເງິນ</p>
                                            <h4 class="text-white">
                                                <?php echo number_format($show_count_pm_pcp_itr_month[0]) ?> ກີບ
                                            </h4>
                                            <small>
                            ...
                            <div class="widget-stat card bg-secondary">
                                <div class="card-body p-4">
                                    <div class="media">
                                        ...
                                        <div class="media-body text-white">
                                            <p class="mb-1 fs-18">ຈຳນວນການຢືນຢັນປ່ອຍສິນເຊື່ອພາຍໃນປີນີ້</p>
                                            <h4 class="text-white">
                                                <?php echo $show_count_cus_date_in_year[0] ?> ລາຍການ
                                            </h4>
                                            <p class="mb-1 fs-18">ລວມເປັນເງິນ</p>
                                            <h4 class="text-white">
                                                <?php echo number_format($show_count_pm_pcp_itr_year[0]) ?> ກີບ
                                            </h4>
                                            <small>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="credit_release_insert.php" class="btn me-2 btn-primary submit"><i
                                        class="bi bi-person-plus-fill me-2"></i>ປ່ອຍສິນເຊື່ອ</a>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($users as $row) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $row['cr_set_month']; ?> ເດືອນ
                                                    </td>
                                                    <td>
                                                        <?php echo number_format($row['cr_ap_mounnt']); ?> LAK
                                                    </td>
                                                    <td>
                                                        <?php echo $row['cr_ap_amount_text']; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row['cr_interest']; ?> %
                                                    </td>
                                                    <td>
                                                        <?php echo $row['cr_date_in']; ?>
                                                    </td>
                                                    <td>
                                                        <?php
                                                        if ($row['cr_status'] == 1) {
