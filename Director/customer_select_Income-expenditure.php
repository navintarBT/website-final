                            ...
                            <div class="card-body d-flex">
                                ...
                                <div>
                                    <h2 class="text-white invoice-num">
                                        <?php echo $show_count_cus_id[0] ?> ຄົນ
                                    </h2>
                    ...
                    <div style="cursor: pointer;" class="col-xl-3 col-xxl-3 col-sm-6">
                        <div class="card bg-success invoice-card">
                            <div class="card-body d-flex">
                                ...
                                <div>
                                    <h2 class="text-white invoice-num">
                                        <?php echo $show_count_cus_status0[0] ?> ຄົນ
                                    </h2>
                    ...
                    <div style="cursor: pointer;" class="col-xl-3 col-xxl-3 col-sm-6">
                        <div class="card bg-info invoice-card">
                            <div class="card-body d-flex">
                                ...
                                <div>
                                    <h2 class="text-white invoice-num">
                                        <?php echo $show_count_cus_status1[0] ?> ຄົນ
                                    </h2>
                    ...
                    <div style="cursor: pointer;" class="col-xl-3 col-xxl-3 col-sm-6">
                        <div class="card bg-secondary invoice-card">
                            <div class="card-body d-flex">
                                ...
                                <div>
                                    <h2 class="text-white invoice-num">
                                        <?php echo $show_count_cus_status2[0] ?> ຄົນ
                                    </h2>
                            ...
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white text-end">
                                        ...
                                        <h3 class="text-white">
                                            <?php echo number_format($shohw_total_income) ?> ກີບ
                                        </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white text-end">
                                        ...
                                        <h3 class="text-white">
                                            <?php echo number_format($shohw_total_income_min); ?> ກີບ
                                        </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white text-end">
                                        ...
                                        <h3 class="text-white">
                                            <?php echo number_format($shohw_total_expenses_max) ?> ກີບ
                                        </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white text-end">
                                        ...
                                        <h3 class="text-white">
                                            <?php echo number_format($shohw_total_expenses_min) ?> ກີບ
                                        </h3>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="mb-3 me-auto">
                        <div class="card-tabs style-1 mt-3 mt-sm-0">
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <a style="font-size: 16px;" class="nav-link active" href="javascript:void(0);"
                                        data-bs-toggle="tab" id="transaction-tab" data-bs-target="#AllTransaction"
                                        role="tab">ລາຍຮັບ</a>
                                </li>
                                <li class="nav-item">
                                    <a style="font-size: 16px;" class="nav-link" href="javascript:void(0);"
                                        data-bs-toggle="tab" id="Completed-tab" data-bs-target="#Completed"
                                        role="tab">ລາຍຈ່າຍ</a>
                                </li>
                                <li class="nav-item">
                                    <a style="font-size: 16px;" class="nav-link" href="javascript:void(0);"
                                        data-bs-toggle="tab" id="Pending-tab" data-bs-target="#Pending"
                                        role="tab">ລາຍຮັບ - ລາຍຈ່າຍ</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <a href="customer_insert.php" class="btn btn-outline-primary mb-3"><i
                            class="fa fa-calendar me-3 scale3"></i>ເພີ້ມລູກຄ້າ</a>
                </div>
                <div class="row">
                    <div class="card">
                                                    ...
                                                    <th>
                                                        <div class="form-check custom-checkbox">
                                                            <input style="cursor: pointer;" type="checkbox"
                                                                class="form-check-input" id="checkAll" required="">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($users as $row) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php echo $row['cus_runing']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $row['cus_fname']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo number_format($row['cus_income_salary']); ?> LAK
                                                        </td>
                                                        <td>
                                                            <?php echo number_format($row['cus_income_famiry']); ?> LAK
                                                        </td>
                                                        <td>
                                                            <?php echo number_format($row['cus_income_trading']); ?> LAK
                                                        </td>
                                                        <td>
                                                            <?php echo number_format($row['cus_income_rental']); ?> LAK
                                                        </td>
                                                        <td>
                                                            <?php echo number_format($row['cus_special_income']); ?> LAK
                                                        </td>
                                                        <td>
                                                            <?php echo number_format($row['cus_total_income']); ?> LAK
                                                        </td>
                                                        <td class="text-success"> <span class="me-2 oi-icon bgl-success">
                                                            ...
                                                            <?php echo $row['percentage_income']; ?> %
                                                        </td>
                                                        <td>
                                                            <div class="btn-group dropstart">
                                                                ...
                                                                <div style="background: #FDFEFE;" class="dropdown-menu">
                                                                    ...
                                                                    <a class="dropdown-item"
                                                                        href="#">ເບິ່ງຂໍ້ມູນເພີ້ມຕື່ມ</a>
                                                                    <a class="dropdown-item"
                                                                        href="docs/<?php echo $row['cus_doc']; ?>">ເບິ່ງເອກກະສານຂໍ້ກູ້ຢຶມເງິນ</a>
                                                                    <a class="dropdown-item"
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($users as $row) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php echo number_format($row['cus_expenditure_invest']); ?> LAK
                                                        </td>
                                                        <td>
                                                            <?php echo number_format($row['cus_expenditure_house_rent']); ?>LAK
                                                        </td>
                                                        <td>
                                                            <?php echo number_format($row['cus_expenditure_normal']); ?> LAK
                                                        </td>
                                                        <td>
                                                            <?php echo number_format($row['cus_expenditure_debt']); ?> LAK
                                                        </td>
                                                        <td>
                                                            <?php echo number_format($row['cus_expenditure_other']); ?> LAK
                                                        </td>
                                                        <td>
                                                            <?php echo number_format($row['cus_total_expenses']); ?> LAK
                                                        </td>
                                                        <td class="text-danger"> <span class="me-2 oi-icon bgl-danger">
                                                            ...
                                                            <?php echo $row['percentage_expenses']; ?> %
                                                        </td>
                                                        <td>
                                                            <div class="btn-group dropstart">
                                                                <div class="btn-link" data-bs-toggle="dropdown">
                                                        ...
                                                        <td>
                                                            <div class="col-xl-12">
                                                                <div style="
                                                                    ...
                                                                    <div class="card-body pb-3">
                                                                        <div class="row align-items-center">
                                                                            ...
                                                                            <div class="col-xl-3">
                                                                                ...
                                                                                <h3 style="color: #8E44AD;" class="mb-0">
                                                                                    <?php echo number_format($row['cus_amount_income']); ?>
                                                                                    LAK</h2>
                                                                            </div>
                                                                            <div
                                                                                class="col-xl-3 d-flex flex-wrap justify-content-end align-items-center">
                                                                                <div class="btn-group dropstart mb-1">
                                                                                    ...
                                                                                    <div style="background: #FDFEFE;"
                                                                                        ...
                                                                                        <a class="dropdown-item"
                                                                                            href="customer_collateral.php?id=<?php echo $row['cus_id']; ?>">ເບິ່ງຂໍ້ມູນຫຼັກຊັບຄ້ຳປະກັນ</a>
                                                                                        <a class="dropdown-item"
                                                                                            href="customer_gurarantor.php?id=<?php echo $row['cus_id']; ?>">ເບິ່ງຂໍ້ມູນຜູ້ຄ້ຳປະກັນ</a>
                                                                                        <a class="dropdown-item"
                                                                                            href="docs/<?php echo $row['cus_doc']; ?>">ເບິ່ງເອກກະສານຂໍ້ກູ້ຢຶມເງິນ</a>
                                                                                        <hr>
                                                                                        <a class="dropdown-item button_edit"
                                                                    ...
                                                                    <div
                                                                        class="card-body transaction-details d-flex flex-wrap justify-content-between align-items-center">
                                                                        <div class="me-1 mb-1">
                                                                            <h4 class="mb-2">ເງິນເດືອນປະຈຳ (ຜົວ-ເມຍ)</h4>
                                                                            <h4 style="color: #2ECC71;" class="mb-0">
                                                                                <?php echo number_format($row['cus_income_salary']); ?>
                                                                                LAK
                                                                            </h4>
                                                                        </div>
                                                                        <div class="me-1 mb-1">
                                                                            ...
                                                                            <h4 style="color: #2ECC71;" class="mb-0">
                                                                                <?php echo number_format($row['cus_income_famiry']); ?>
                                                                                LAK
                                                                            </h4>
                                                                        </div>
                                                                        <div class="me-1 mb-1">
                                                                            ...
                                                                            <h4 style="color: #2ECC71;" class="mb-0">
                                                                                <?php echo number_format($row['cus_income_trading']); ?>
                                                                                LAK
                                                                            </h4>
                                                                        </div>
                                                                        <div class="me-1 mb-1">
                                                                            ...
                                                                            <h4 style="color: #2ECC71;" class="mb-0">
                                                                                <?php echo number_format($row['cus_income_rental']); ?>
                                                                                LAK
                                                                            </h4>
                                                                        </div>
                                                                        <div class="me-1 mb-1">
                                                                            ...
                                                                            <h4 style="color: #2ECC71;" class="mb-0">
                                                                                <?php echo number_format($row['cus_special_income']); ?>
                                                                                LAK
                                                                            </h4>
                                                                        </div>
                                                                        <div class="me-1 mb-1">
                                                                            ...
                                                                            <h4 style="color: #2ECC71;" class="mb-0">
                                                                                <?php echo number_format($row['cus_total_income']); ?>
                                                                                LAK
                                                                            </h4>
                                                                        </div>
                                                                        <div class="me-1 mb-1">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="me-1 mb-1">
                                                                            ...
                                                                            <h4 style="color: #E74C3C;" class="mb-0">
                                                                                <?php echo number_format($row['cus_expenditure_invest']); ?>
                                                                                LAK
                                                                            </h4>
                                                                        </div>
                                                                        <div class="me-1 mb-1">
                                                                            ...
                                                                            <h4 style="color: #E74C3C;" class="mb-0">
                                                                                <?php echo number_format($row['cus_expenditure_house_rent']); ?>
                                                                                LAK
                                                                            </h4>
                                                                        </div>
                                                                        <div class="me-1 mb-1">
                                                                            ...
                                                                            <h4 style="color: #E74C3C;" class="mb-0">
                                                                                <?php echo number_format($row['cus_expenditure_normal']); ?>
                                                                                LAK
                                                                            </h4>
                                                                        </div>
                                                                        <div class="me-1 mb-1">
                                                                            ...
                                                                            <h4 style="color: #E74C3C;" class="mb-0">
                                                                                <?php echo number_format($row['cus_expenditure_debt']); ?>
                                                                                LAK
                                                                            </h4>
                                                                        </div>
                                                                        <div class="me-1 mb-1">
                                                                        ...
                                                                        <div class="me-1 mb-1">
                                                                            ...
                                                                            <h4 style="color: #E74C3C;" class="mb-0">
                                                                                <?php echo number_format($row['cus_expenditure_other']); ?>
                                                                                LAK
                                                                            </h4>
                                                                        </div>
                                                                        <div class="me-1 mb-1">
                                                                        ...
                                                                        <div style="background: #F5B7B1;"
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <h3 class="mb-0">
                                                                                    <?php echo number_format($row['cus_total_expenses']); ?>
                                                                                    LAK
                                                                                </h3>
                                                                            </div>
                                                                        </div>
