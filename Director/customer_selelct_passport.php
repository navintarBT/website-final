                            ...
                            <div class="card-body d-flex">
                                ...
                                <div>
                                    ...
                                    <h2 class="text-white invoice-num">
                                        <?php echo $show_count_cus_id[0] ?> ລາຍການ
                                    </h2>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white text-end">
                                        ...
                                        <h3 class="text-white">
                                            <?php echo $show_count_cus_passprot_expiry_date[0] ?> ຄົນ
                                        </h3>
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <div class="btn-group dropstart mb-1">
                                                            ...
                                                            <div style="background: #FDFEFE;" class="dropdown-menu">
                                                                ...
                                                                <a class="dropdown-item button_edit"
                                                                    href="customer_update_passport.php?id=<?php echo $row['cus_id']; ?> ">ແກ້ໄຂຂໍ້ມູນ</a>
