            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">ລາຍງານຂໍ້ມູນລູກຄ້າທັງໝົດພາຍໃນມື້ນີ້</a>
                        </li>
                    </ol>
                </div>
                <!-- row -->
                                ...
                                <div class="card-body p-4">
                                    <div class="media">
                                        ...
                                        <div class="media-body text-white">
                                            ...
                                            <h3 class="text-white">
                                                <?php echo $show_count_cus_date_in[0] ?> ຄົນ
                                            </h3>
                                ...
                                <div class="card-body  p-4">
                                    <div class="media">
                                        ...
                                        <div class="media-body text-white">
                                            ...
                                            <h3 class="text-white">
                                                <?php echo $show_count_cus_date_in_week[0] ?> ຄົນ
                                            </h3>
                                ...
                                <div class="card-body p-4">
                                    <div class="media">
                                        ...
                                        <div class="media-body text-white">
                                            ...
                                            <h3 class="text-white">
                                                <?php echo $show_count_cus_date_in_month[0] ?> ຄົນ
                                            </h3>
                                ...
                                <div class="card-body p-4">
                                    <div class="media">
                                        ...
                                        <div class="media-body text-white">
                                            ...
                                            <h3 class="text-white">
                                                <?php echo $show_count_cus_date_in_year[0] ?> ຄົນ
                                            </h3>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="customer_insert.php" style="cursor: pointer;" class="btn me-2 btn-primary"><i
                                        class="bi bi-person-plus-fill me-2"></i>ບັນທືກລູກຄ້າ</a>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_array($sql)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $row['cus_vill']; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row['cus_dis']; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row['cus_pro']; ?>
                                                    </td>
                                                        ...
                                                        <div class="btn-group dropstart mb-1">
                                                            ...
                                                            <div style="background: #FDFEFE;" class="dropdown-menu">
                                                                ...
                                                                <a class="dropdown-item button_edit"
                                                                    href="customer_update_history.php?id=<?php echo $row['cus_id']; ?> ">ແກ້ໄຂຂໍ້ມູນ</a>
