                            ...
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white text-end">
                                        ...
                                        <h3 class="text-white">
                                            <?php echo number_format($shohw_total_expenses_max[0]); ?> ກີບ
                                        </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white text-end">
                                        ...
                                        <h3 class="text-white">
                                            <?php echo number_format($shohw_total_expenses_min[0]) ?> ກີບ
                                        </h3>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="customer_insert.php" class="btn me-2 btn-primary submit"><i
                                        class="bi bi-person-plus-fill me-2"></i>ເພີ້ມລູກຄ້າ</a>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_array($sql)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $row['cus_purpose_money']; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo number_format($row['cus_qty_money']); ?> LAK
                                                    </td>
                                                    <td>
                                                        <?php echo $row['cus_date_of_loan']; ?> ເດືອນ
                                                    </td>
                                                    <td>
                                                        <?php echo $row['cus_collateral_assets']; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row['cus_regular_money']; ?>
                                                    </td>
                                                        ...
                                                        <div class="btn-group dropstart mb-1">
                                                            ...
                                                            <div style="background: #FDFEFE;" class="dropdown-menu">
                                                                ...
                                                                <a class="dropdown-item button_edit"
                                                                    href="customer_update_offer.php?id=<?php echo $row['cus_id']; ?> ">ແກ້ໄຂຂໍ້ມູນ</a>
