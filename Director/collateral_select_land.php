        ...
        <div class="content-body ">
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a href="javascript:void(0)"></a>ລາຍງານຂໍ້ມູນຫຼັບຊັບຄ້ຳປະກັນ
                            ທີ່ດິນ-ທີ່ດິນພ້ອມສິ່ງປູກສ້າງ</li>
                    </ol>
                </div>
                <!-- row -->
                        ...
                        <a href="collateral_la_status1.php">
                            <div class="card bg-info invoice-card">
                                <div class="card-body d-flex">
                                    ...
                                    <div>
                                        <h2 class="text-white invoice-num">
                                            <?php echo $show_count_la_status1[0] ?> ລາຍງານ
                                        </h2>
                        ...
                        <a href="collateral_la_status2.php">
                            <div class="card bg-secondary invoice-card">
                                <div class="card-body d-flex">
                                    ...
                                    <div>
                                        <h2 class="text-white invoice-num">
                                            <?php echo $show_count_la_status2[0] ?> ລາຍການ
                                        </h2>
                            ...
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white text-end">
                                        ...
                                        <h3 class="text-white">
                                            <?php echo number_format($show_total_expenses) ?> ກີບ
                                        </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white text-end">
                                        ...
                                        <h3 class="text-white">
                                            <?php echo number_format($show_total_expensesmin) ?> ກີບ
                                        </h3>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">ຕາຕະລາງລາຍລະອຽດຂໍ້ມູນຫຼັບຊັບຄ້ຳປະກັນ ທີ່ດິນ-ທີ່ດິນພ້ອມສິ່ງປູກສ້າງ
                                </h4>
                                <a href="collateral_insert_land.php" style="cursor: pointer;"
                                    class="btn me-2 btn-primary"><i
                                        class="bi bi-person-plus-fill me-2"></i>ບັນທຶກຫຼັກຊັບຄ້ຳປະກັນ</a>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($users as $row) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $row['la_runing_id']; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row['la_type']; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row['la_land_title']; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row['la_date']; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row['la_name']; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo number_format($row['la_original_price']); ?> LAK
                                                    </td>
                                                    <td>
                                                        <?php echo number_format($row['la_market_price']); ?> LAK
                                                    </td>
                                                    <td>
                                                        <?php echo number_format($row['la_pham']); ?> LAK
                                                    </td>
                                                    <td>
                                                        <?php
                                                        if ($row['la_status'] == 0) {
                                                        ...
                                                        <div class="btn-group dropstart mb-1">
                                                            ...
                                                            <div style="background: #FDFEFE;" class="dropdown-menu">
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="collateral_more_land.php?id=<?php echo $row['la_id']; ?>">ເບິ່ງຂໍ້ມູນເພີ້ມຕື່ມ</a>
                                                                <a class="dropdown-item"
                                                                    href="collateral_docs/<?php echo $row['la_doc_file']; ?>">ໃບລາຍງານການກົດສອບຊັບສົມບັດ</a>
                                                                <hr>
                                                                <a class="dropdown-item button_edit"
                                                                    href="collateral_update_land.php?id=<?php echo $row['la_id']; ?>">ແກ້ໄຂຂໍ້ມູນ</a>
                                                                <a data-la_id="<?= $row['la_id']; ?>"
                                                                    href="?delete=<?= $row['la_id']; ?>"
