...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>ລາຍງານຂໍ້ມູນຜູ້ນຳໃຊ້</title>
    ...
    if (isset($_GET['action']) && $_GET['action'] === 'delete' && isset($_GET['user_id'])) {
        ...
        $delete_stmt->execute();
        unlink("../user_images" . $row['user_image']);
    }
    ?>
</head>
...
<body>
    ...
    $sql_count_cus_date_in = mysqli_query($conns, "select count(user_id) from users");
    $show_count_cus_date_in = mysqli_fetch_array($sql_count_cus_date_in);

    $sql_count_cus_date_in_week = mysqli_query($conns, "select count(user_id) from users where user_satus = 'ແອັດມິນ' ");
    $show_count_cus_date_in_week = mysqli_fetch_array($sql_count_cus_date_in_week);

    $sql_count_cus_date_in_month = mysqli_query($conns, "select count(user_id) from users where user_satus = 'ສິນເຊື່ອ' ");
    $show_count_cus_date_in_month = mysqli_fetch_array($sql_count_cus_date_in_month);

    $sql_count_cus_date_in_year = mysqli_query($conns, "select count(user_id) from users where user_satus = 'ການເງິນ' ");
    $show_count_cus_date_in_year = mysqli_fetch_array($sql_count_cus_date_in_year);

    $sql_count_user_gender = mysqli_query($conns, "select count(user_id) from users where user_gender = 'ເພດຍິງ' ");
    $show_count_user_gender = mysqli_fetch_array($sql_count_user_gender);

    $sql_count_user_gender1 = mysqli_query($conns, "select count(user_id) from users where user_gender = 'ເພດຊາຍ' ");
    $show_count_user_gender1 = mysqli_fetch_array($sql_count_user_gender1);
    ?>
                    ...
                    <ul aria-expanded="false">
                        <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                ...
                                <li><a style="font-size: 16px;" href="">ລາຍງານຂໍ້ມູນພະນັກງານເຄົາເຕີ້</a></li>
                            </ul>
                        </li>
                        <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                                <span style="font-size: 16px;" class="nav-text">ຈັດການຂໍ້ມູນພະນັກງານການເງິນ</span>
                        ...
                        <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                ...
                                <li><a style="font-size: 16px;" href="">ລາຍງານຂໍ້ມູນພະນັກງານສິນເຊື່ຶ</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
        ...
        <div class="content-body ">
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a href="javascript:void(0)"></a>ຂໍ້ມູນຜູ້ນຳໃຊ້</li>
                        <li class="breadcrumb-item"><a href="javascript:void(0)">ລາຍງານຂໍ້ມູນຜູ້ນຳໃຊ້</a></li>
                    </ol>
                </div>
                <!-- row -->
                ...
                <div class="row invoice-card-row">
                            ...
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white">
                                        <p class="mb-1 fs-18">ຜູ້ນຳໃຊ້ທັງໝົດ</p>
                        ...
                        <div class="widget-stat card bg-danger">
                            <div class="card-body  p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white">
                                        <p class="mb-1 fs-18">ຈຳນວນຜູ້ນຳໃຊ້ທີເປັນແອັດມິນ</p>
                        ...
                        <div class="widget-stat card bg-warning">
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white">
                                        <p class="mb-1 fs-18">ຈຳນວນຜູ້ນຳໃຊ້ທີ່ເປັນພະນັກງານສິນເຊື່ອ</p>
                        ...
                        <div class="widget-stat card bg-secondary">
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white">
                                        <p class="mb-1 fs-18">ຈຳນວນຜູ້ນຳໃຊ້ທີ່ເປັນພະນັກງານການເງິນ</p>
                    ...
                    <div class="col-xl-6 col-xxl-6 col-lg-6 col-sm-6">
                        <div style="background: #FF647F;" class="widget-stat card">
                            <div class="card-body p-4">
                                <div class="media">
                                    <span class="me-3">
                                        <i style="font-size: 80px;" class="las la-female"></i>
                                    </span>
                                    <div class="media-body text-white">
                                        <p class="mb-1 fs-18">ຈຳນວນຜູ້ນຳໃຊ້ເພດຍິງ</p>
                                        <h3 class="text-white"><?php echo $show_count_user_gender[0] ?> ຄົນ</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-6 col-xxl-6 col-lg-6 col-sm-6">
                        <div style="background: #2471A3;" class="widget-stat card">
                            <div class="card-body p-4">
                                <div class="media">
                                    <span class="me-3">
                                        <i style="font-size: 80px;" class="las la-male"></i>
                                    </span>
                                    <div class="media-body text-white">
                                        <p class="mb-1 fs-18">ຈຳນວນຜູ້ນຳໃຊ້ເພດຊາຍ</p>
                                        <h3 class="text-white"><?php echo $show_count_user_gender1[0] ?> ຄົນ</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">ຕາຕະລາງລາຍລະອຽດຂໍ້ມູນລາຍງານຂໍ້ມູນຜູ້ນຳໃຊ້</h4>
                                <a href="user_insert.php" class="btn btn-outline-primary">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="../user_images/<?php echo $row['user_image']; ?>" alt="" class="rounded-circle me-3" width="50">
                                                            <div>
                                                                <h6 class="fs-16 mb-0 text-nowrap"><?php echo $row['user_flname']; ?></h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td><?php echo $row['user_gender']; ?></td>
                                                    <td><?php echo $row['user_dob']; ?></td>
                                                    <td><?php echo $row['user_age']; ?> ປີ</td>
                                                    <td>ສັນຊາດ <?php echo $row['user_nationality']; ?></td>
                                                    <td>ຊົນເຜົ່າ <?php echo $row['user_ethnicity']; ?></td>
                                                    <td>ສາສະໜາ <?php echo $row['user_religion']; ?></td>
                                                    <td><?php echo $row['user_vill']; ?></td>
                                                    <td><?php echo $row['user_dis']; ?></td>
                                                    <td><?php echo $row['user_pro']; ?></td>
                                                    <td><?php
                                                        if ($row['user_satus'] == "ແອັດມິນ") {
                                                            echo "
                                                            ...
                                                            ";
                                                        } else if ($row['user_satus'] == "ສິນເຊື່ອ") {
                                                            echo "
                                                            ...
                                                            ";
                                                        } else if ($row['user_satus'] == "ການເງິນ") {
                                                            echo "
                                                            <span style='font-size: 16px;' class='badge light badge-info'>
                                                            <i class='fa fa-circle text-info me-1'></i>
                                                            ການເງິນ
                                                            </span>
                                                            ";
                                                        } else if ($row['user_satus'] == "ເຄົາເຕີ") {
                                                            echo "
                                                            ...
                                                            ";
                                                        } else if ($row['user_satus'] == "ອຳນວຍການ") {
                                                            echo "
                                                            <span style='font-size: 16px;' class='badge light badge-primary'>
                                                    ...
                                                    <td>
                                                        <div class="btn-group dropstart mb-1">
                                                            ...
                                                            <div style="background: #FDFEFE;" class="dropdown-menu">
                                                                ...
                                                                <hr>
                                                                <a class="dropdown-item button_edit" href="user_update.php?id=<?php echo $row['user_id']; ?>">ແກ້ໄຂຂໍ້ມູນ</a>
                ...
                preConfirm: function() {
                    return new Promise(function(resolve) {
                        $.ajax({
                                ...
                                data: {
                                    user_id: userId,
                                    action: 'delete' // You might need to include an action parameter to indicate the action to perform in your PHP script
                                },
                            })
                            .done(function() {
                                Swal.fire({
