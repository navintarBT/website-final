...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>ລາຍງານຂໍ້ມູນການປິດສັນຍາພາຍໃນມື້ນີ້</title>
                    ...
                    <nav class="navbar navbar-expand">
                        <div class="collapse navbar-collapse justify-content-between">
                            <div class="header-left">
                                ...
                                ລາຍງານຂໍ້ມູນການປິດສັນຍາພາຍໃນມື້ນີ້
                                </div>
                            </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:void(0)">ລາຍງານຂໍ້ມູນການປິດສັນຍາຟາຍໃນມື້ນີ້</a></li>
                        </ol>
                    </div>
                    <!-- row -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">ຕາຕະລາງລາຍລະອຽດຂໍ້ມູນລາຍງານຂໍ້ມູນການປິດສັນຍາມື້ນີ້</h4>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example" class="display" style="min-width: 845px">
                                            ...
                                            <tbody>
                                                <?php
                                                $stmt = $conn->query("select * from close_payment where cp_date_in = curdate()");
                                                $stmt->execute();
                                                $users = $stmt->fetchAll();
