...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>ລາຍງານຂໍ້ມູນຫຼັກຊັບຄ້ຳປະກັນອື່ນໆ</title>
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            <div class="dashboard_bar">
                                ຂໍ້ມູນເພີ່ມເຕີມຫຼັກຊັັບຄ້ຳປະກັນອື່ນໆ
                            </div>
                        </div>
        ...
        <div class="content-body ">
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a href="javascript:void(0)"></a>ຂໍ້ມູນຫຼັກຊັບຄ້ຳປະກັນ</li>
                        <li class="breadcrumb-item"><a href="javascript:void(0)">ລາຍງານຂໍ້ມູນຫຼັກຊັບຄ້ຳປະກັ</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0)">ລາຍງານຂໍ້ມູນເພີ່ມເຕີມຫຼັກຊັບຄ້ຳປະກັນອື່ນໆ</a></li>
                    </ol>
                </div>
                <!-- row -->
