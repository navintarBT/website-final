                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a
                                href="javascript:void(0)"></a>ຂໍ້ມູນຫຼັກຊັັບຄ້ຳປະກັນລົດຈັກ-ລົດໃຫຍ່</li>
                        <li class="breadcrumb-item"><a
                                href="javascript:void(0)">ລາຍງານຂໍ້ມູນຫຼັກຊັັບຄ້ຳປະກັນລົດຈັກ-ລົດໃຫຍ່</a></li>
                        <li class="breadcrumb-item"><a
                                href="javascript:void(0)">ລາຍງານຂໍ້ມູນເພີ່ມຫຼັກຊັັບຄ້ຳປະກັນລົດຈັກ-ລົດໃຫຍ່</a></li>
                    </ol>
                </div>
                <!-- row -->
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div style="display: flex;" class="date">
                                        ...
                                        <h4 class="card-title">&nbsp;&nbsp;&nbsp;
                                            <?= $collateral_car['car_date_in']; ?>
                                        </h4>
                                        <h4 class="card-title">&nbsp;&nbsp;&nbsp;
                                            <?= $collateral_car['car_time_in']; ?>
                                        </h4>
                                    </div>
                                </div>
                                <div class="card-body">
                                            ...
                                            <div style="margin-top: -1rem;" class="row">
                                                <div class="col-xl-3">
                                                    <label class="col-form-label"
                                                        for="validationCustom06">ລະຫັດຫຼັກຊັບຄ້ຳປະກັນ

                                                    </label>
                                                    <div class="input-group">

                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text" class="form-control car_running_id"
                                                            id="validationCustom01"
                                                            value="<?= $collateral_car['car_running_id']; ?>"
                                                            required="" name="car_running_id" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mb-1 row">
                                                <div class="col-xl-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text" value="<?= $collateral_car['cus_runing']; ?>"
                                                            class="form-control cus_runing" id="validationCustom01"
                                                            placeholder="ປ້ອນລະຫັດລູກຄ້າ..." required=""
                                                            name="cus_runing">
                                                    </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text" value="<?= $collateral_car['cus_fname']; ?>"
                                                            class="form-control cus_fname" id="validationCustom01"
                                                            placeholder="ປ້ອນຊື່ ແລະ ນາມສະກຸນ..." required=""
                                                            name="cus_fname" readonly>
                                                    </div>
                                                    <label class="col-form-label"
                                                        for="validationCustom06">ຊື່ຜູ້ລົງກວດການຕົວຈິງ
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text"
                                                            value="<?= $collateral_car['car_check_name']; ?>"
                                                            class="form-control car_check_name" id="validationCustom01"
                                                            placeholder="ປ້ອນຊື່ຜູ້ລົງກວດການຕົວຈິງ..." required=""
                                                            name="car_check_name">
                                                    </div>
                                                    <label class="col-form-label"
                                                        for="validationCustom06">ວັນທີລົງກວດສອບ
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text" class="form-control car_date_check"
                                                            value="<?= $collateral_car['car_date_check']; ?>"
                                                            id="validationCustom01"
                                                            placeholder="ປ້ອນຊື່ຜູ້ລົງກວດການຕົວຈິງ..." required=""
                                                            name="car_date_check">
                                                    </div>
                                                ...
                                                <div class="col-xl-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text" class="form-control car_time_check"
                                                            value="<?= $collateral_car['car_time_check']; ?>"
                                                            id="validationCustom01" placeholder="ປ້ອນເລກລະບຽນລົດ..."
                                                            required="" name="car_time_check">
                                                    </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            text type="text"
                                                            value="<?= $collateral_car['car_number']; ?>"
                                                            class="form-control car_number" id="validationCustom01"
                                                            placeholder="ປ້ອນເລກລະບຽນລົດ..." required=""
                                                            name="car_number">
                                                    </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text" value="<?= $collateral_car['car_eg_number']; ?>"
                                                            class="form-control car_eg_number" id="validationCustom01"
                                                            placeholder="ປ້ອນເລກຈັກ..." required="" value=""
                                                            name="car_eg_number">
                                                    </div>
                                                ...
                                                <div class="col-xl-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text" value="<?= $collateral_car['car_t_number']; ?>"
                                                            class="form-control car_t_number" id="validationCustom01"
                                                            placeholder="ປ້ອນເລກຖັງ..." required="" name="car_t_number">
                                                    </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text" value="<?= $collateral_car['car_brand']; ?>"
                                                            class="form-control car_brand" id="validationCustom01"
                                                            placeholder="ປ້ອນຍີ່ຫໍ..." required="" name="car_brand">
                                                    </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text" value="<?= $collateral_car['car_color']; ?>"
                                                            class="form-control car_color" id="validationCustom01"
                                                            placeholder="ປ້ອນສີລົດ..." required="" value=""
                                                            name="car_color">
                                                    </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text" value="<?= $collateral_car['car_name']; ?>"
                                                            class="form-control car_name" id="validationCustom01"
                                                            placeholder="ປ້ອນອອກຊື່..." required="" name="car_name">
                                                    </div>
                                                ...
                                                <div class="col-xl-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text" value="<?= $collateral_car['car_u_year']; ?>"
                                                            class="form-control car_u_year" id="validationCustom01"
                                                            placeholder="ປ້ອນປີນຳໃຊ້..." required="" name="car_u_year">
                                                    </div>
                                                    <label class="col-form-label"
                                                        for="validationCustom06">ມູນຄ່າເດີມຂອງຊັບສົມບັດ
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text"
                                                            value="<?= number_format($collateral_car['car_original_price']); ?> ກີບ"
                                                            class="form-control car_original_price"
                                                            id="validationCustom01" placeholder="0.00" required=""
                                                            name="car_original_price">
                                                    </div>
                                                    <label class="col-form-label"
                                                        for="validationCustom06">ມູນຄ້າຊັບສົມບັດ ຕາມລາຄາຕະຫຼາດ
                                                    ...
                                                    <div class="input-group">
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text"
                                                            value="<?= number_format($collateral_car['car_market_price']); ?> ກີບ"
                                                            class="form-control car_original_price"
                                                            id="validationCustom01" placeholder="0.00" required=""
                                                            name="car_original_price">
                                                    ...
                                                    <label class="col-form-label"
                                                        for="validationCustom06">ມູນຄ້າປະເມີນຂອງພະນັກງານ
                                                    ...
                                                    <div class="input-group">
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text"
                                                            value="<?= number_format($collateral_car['car_pham']); ?> ກີບ"
                                                            class="form-control car_original_price"
                                                            id="validationCustom01" placeholder="0.00" required=""
                                                            name="car_original_price">
                    ...
                    <div class=" row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <input style="height: 200px; border: none; font-size: 18px; margin-left: -1.3rem;"
                                        value="<?= $collateral_car['car_explain']; ?>" type="text" class="form-control"
                                        id="validationCustom01" name="car_explain">
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-3">
                                            ...
                                            <img width="100%" id="previewImg"
                                                src="collateral_car_images/<?php echo $collateral_car['car_image0']; ?>"
                                                alt="">
                                        </div>
                                        <div class="col-xl-3">

                                            <img width="100%" id="previewImg1"
                                                src="collateral_car_images/<?php echo $collateral_car['car_image1']; ?>"
                                                alt="">
                                        </div>
                                        <div class="col-xl-3">

                                            <img width="100%" id="previewImg2"
                                                src="collateral_car_images/<?php echo $collateral_car['car_image2']; ?>"
                                                alt="">
                                        </div>
                                        <div class="col-xl-3">

                                            <img width="100%" id="previewImg3"
                                                src="collateral_car_images/<?php echo $collateral_car['car_image3']; ?>"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input style="border: none; font-size: 18px; margin-left: -1.3rem;" type="text"
                                            value="<?= $collateral_car['car_doc_name']; ?>"
                                            class="form-control car_doc_name" name="car_doc_name"
                                            id="validationCustom01" placeholder="ປ້ອນຊື່ເອກະສານ..." required="">
                                    </div>
