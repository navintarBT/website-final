...
//ສ້າງລະຫັດຜູ້ນຳໃຊ້ອັດຕະໂນມັດ
require_once "config/conect_nal.php";
$query = "SELECT count(user_id)  FROM users  ORDER BY user_id DESC LIMIT 1; ";
...
if ($row == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $select_stmt->execute();
        $user_ids = $select_stmt->fetch(PDO::FETCH_ASSOC);
				...
				<div class="dlabnav-scroll">
					<ul class="metismenu" id="menu">
						...
						<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
								...
								<span class="nav-text">ລາຍຂໍ້ມູນລູກຄ້າ</span>
							</a>
							<ul aria-expanded="false">
								...
								<li><a style="font-size: 18px;" href="customer_select_Income-expenditure.php">ຂໍ້ມູນລາຍຮັບ - ລາຈ່າຍລູກຄ້າ</a>
							</ul>
						</li>
						<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
								<i style="font-size: 24px;" class="bi bi-map-fill"></i>
								<span class="nav-text">ລາຍງານຫຼັກຊັບຄຳປະກັນ</span>
							</a>
							<ul aria-expanded="false">
						...
						<li><a class="ai-icon" href="credit_analysis_select.php" aria-expanded="false">
								<i class="flaticon-041-graph"></i>
								<span class="nav-text">ລາຍງານການວິເຄາະສິນເຊື່ອ</span>
							</a>
						</li>
						<li><a class="ai-icon" href="guarantor_select.php" aria-expanded="false">
								<i style="font-size: 28px;" class="bi bi-people-fill"></i>
								<span class="nav-text">ລາຍງານຂໍ້ມູນຜູ້ຄ້ຳປະກັນ</span>
							</a>
						</li>
						<li><a class="ai-icon" href="loan_agreement_select.php" aria-expanded="false">
								<i style="font-size: 28px;" class="bi bi-card-checklist"></i>
								<span class="nav-text">ລາຍງານສັນຍາກູ້ຢຶມ</span>
							</a>
						</li>
						<li><a class=" ai-icon" href="credit_release_select.php" aria-expanded="false">
								<i style="font-size: 30px;" class="bi bi-box-arrow-right"></i>
								<span class="nav-text">ລາຍງານການປ່ອຍສິນເສື່ອ</span>
							</a>
						</li>
						<li><a href="debt_select.php" class="ai-icon" aria-expanded="false">
								<i style="font-size: 30px;" class="bi bi-cash-stack"></i>
								<span class="nav-text">ລາຍງານໜີ້ສິນ</span>
							</a>
						</li>
						<li><a class=" ai-icon" href="payment_select.php" aria-expanded="false">
								<i style="font-size: 30px;" class="bi bi-box-arrow-left"></i>
								<span class="nav-text">ລາຍງານການຊຳລະ</span>
							</a>
						</li>
						<li><a class=" ai-icon" href="close_payment_select.php" aria-expanded="false">
								<i style="font-size: 30px;" class="bi bi-credit-card-2-front-fill"></i>
								<span class="nav-text">ລາຍງານການປິດສັນຍາ</span>
							</a>
						</li>
						<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">ບັນທຶກຂໍ້ຜູ້ນຳໃຊ້</a></li>
                    </ol>
                </div>
                <!-- row -->
                <form action="" id="customer_insert" class="needs-validation" novalidate="" method="post" enctype="multipart/form-data">
                    <div class=" row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-validation">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="mb-1">
                                                    ...
                                                    <div class="file-upload">
                                                        <div style="height: 340px; margin-top: 0px;" class="image-upload-wrap">
                                                            ...
                                                            <div class="drag-text">
                                                                <h3 style="margin-top: 5.3rem"><i class="bi bi-cloud-arrow-up-fill me-1"></i><b>ອັບໂຫຼດຮູ້ບໂປຣຟາຍ</b></h3>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-xl-3">
                                                <input type="hidden" class="form-control user_id" name="user_id" id="validationCustom06" placeholder="$21.60" value="<?php echo $number ?>" required="">
                                                <label class="col-form-label" for="validationCustom06">ຊື່ ແລະ ນາມສະກຸນ
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="input-group">
                                                    <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                    <input type="text" class="form-control user_flname" name="user_flname" id="validationCustom06" placeholder="ຊື່ ແລະ ນາມສະກຸນ..." required="">
                                                </div>
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                    <input type="date" class="form-control user_dob" name="user_dob" id="validationCustom06" placeholder="ເພດ..." required="">
                                                </div>
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                    <input type="text" class="form-control user_age" name="user_age" id="validationCustom06" placeholder="ອາຍຸ..." required="">
                                                </div>
                                            </div>
                                            <div class="col-xl-3">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                    <input type="text" class="form-control user_nationality" name="user_nationality" id="validationCustom06" placeholder="ສັນລາວ..." required="">
                                                </div>
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                    <input type="text" class="form-control user_ethnicity" name="user_ethnicity" id="validationCustom06" placeholder="ຊົນເຜົ່າ..." required="">
                                                </div>
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                    <input type="text" class="form-control user_religion" name="user_religion" id="validationCustom06" placeholder="ສາສະໜາ..." required="">
                                                </div>
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                    <input type="text" class="form-control user_vill" name="user_vill" id="validationCustom06" placeholder="ບ້ານຢູ່ປັດຈຸບັນ..." required="">
                                                </div>
                                            </div>
                                            <div class="col-xl-3">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                    <input type="text" class="form-control user_dis" name="user_dis" id="validationCustom06" placeholder="ເມືອງ..." required="">
                                                </div>
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                    <input type="text" class="form-control user_pro" name="user_pro" id="validationCustom06" placeholder="ບ້ານ..." required="">
                                                </div>
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                    <input type="text" class="form-control user_tel" name="user_tel" id="validationCustom06" placeholder="ເບີໂທ..." required="">
                                                </div>
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                    <input type="text" class="form-control user_email" name="user_email" id="validationCustom06" placeholder="ອີເມວ..." required="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-12">
                                            <div class="mb-1 row">
                                                <div class="col-xl-3">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                        <input type="text" class="form-control user_name" name="user_name" id="validationCustom06" placeholder="ຊື່ຜູ້ນຳໃຊ້..." required="">
                                                    </div>
                                                ...
                                                <div class="col-xl-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-control form-select user_satus" aria-label="Default select example" id="cus_date_of_loan" required="" name="user_satus" required="">
                                                            <option value="">ເລື້ອກ</option>
                                                            <option value="ແອັດມິນ">ແອັດມິນ</option>
                                                            <option value="ອຳນວຍການ">ອຳນວຍການ</option>
                                                            <option value="ສິນເຊື່ອ">ສິນເຊື່ອ</option>
                                                            <option value="ການເງິນ">ການເງິນ</option>
                                                            <option value="ເຄົາເຕີ">ເຄົາເຕີ</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-xl-3">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                        <input type="password" class="form-control user_password" name="user_password" id="validationCustom06" placeholder="ລະຫັດຜ່ານ..." required="">
                                                    </div>
                                                ...
                                                <div class="col-xl-3">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                        <input type="password" class="form-control user_passwords" name="user_passwords" id="validationCustom06" placeholder="ຢືນຢັນລະຫັດຜ່ານ..." required="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
