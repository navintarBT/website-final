                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a
                                href="javascript:void(0)">ລາຍງານຂໍ້ມູນເພີ່ມຫຼັກຊັັບຄ້ຳປະກັນທີ່ເປັນທີ່ດິນ ຫຼື
                                ທີ່ດິນພ້ອມສິ່ງປູກສ້າງ</a></li>
                    </ol>
                </div>
                <!-- row -->
                <form action="" class="needs-validation" novalidate="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div style="display: flex;" class="date">
                                        ...
                                        <h4 class="card-title">&nbsp;&nbsp;&nbsp;
                                            <?= $collateral_land['la_date_in']; ?>
                                        </h4>
                                        <h4 class="card-title">&nbsp;&nbsp;&nbsp;
                                            <?= $collateral_land['la_time_in']; ?>
                                        </h4>
                                    </div>
                                </div>
                                <div class="card-body">
                                            ...
                                            <div class="mb-1 row">
                                                <div class="col-xl-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            ...
                                                            type="text" class="form-control cus_runing"
                                                            id="validationCustom01"
                                                            value="<?= $collateral_land['cus_runing']; ?>"
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text" class="form-control cus_fname"
                                                            value="<?= $collateral_land['cus_fname']; ?>"
                                                            id="validationCustom01"
                                                            placeholder="ປ້ອນຊື່ ແລະ ນາມສະກຸນ..." required="" readonly
                                                            name="cus_fname">
                                                    </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text" class="form-control la_fname"
                                                            value="<?= $collateral_land['la_fname']; ?>"
                                                            id="validationCustom01"
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text" class="form-control la_date_check"
                                                            value="<?= $collateral_land['la_date_check']; ?>"
                                                            id="validationCustom01"
                                                            placeholder="ປ້ອນຊື່ຜູ້ລົງກວດການຕົວຈິງ..." required=""
                                                            name="la_date_check">
                                                    </div>
                                                ...
                                                <div class="col-xl-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text" class="form-control la_time_check"
                                                            value="<?= $collateral_land['la_time_check']; ?>"
                                                            id="validationCustom01" placeholder="ປ້ອນເລກລະບຽນລົດ..."
                                                            required="" name="la_time_check">
                                                    </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text" class="form-control la_land_title"
                                                            value="<?= $collateral_land['la_land_title']; ?>"
                                                            id="validationCustom01" placeholder="ປ້ອນເລກທີ່ໃບຕາດິນ..."
                                                            required="" name="la_land_title">
                                                    </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text" class="form-control la_date"
                                                            value="<?= $collateral_land['la_date']; ?>" id=""
                                                            placeholder=" ປ້ອນເບີໂທ..." required="" value=""
                                                            name="la_date">
                                                    </div>
                                                    <label class="col-form-label"
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text" class="form-control la_runing_id"
                                                            value="<?= $collateral_land['la_runing_id']; ?>"
                                                            id="validationCustom01" value="" required=""
                                                            name="la_runing_id" readonly>
                                                    </div>
                                                ...
                                                <div class="col-xl-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text" class="form-control la_runing_id"
                                                            value="<?= $collateral_land['la_type']; ?>"
                                                            id="validationCustom01" value="" required=""
                                                            name="la_runing_id" readonly>
                                                    </div>
                                                    <label class="col-form-label"
                                                        for="validationCustom06">ຊິ່ງມີທີ່ຕັ້ງຢູ່ບ້ານ
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text" class="form-control la_vill"
                                                            value="<?= $collateral_land['la_vill']; ?>"
                                                            id=" placeholder=" ປ້ອນບ້ານ..." required="" name="la_vill">
                                                    </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text" class="form-control la_dis"
                                                            value="<?= $collateral_land['la_dis']; ?>"
                                                            id="validationCustom01" placeholder="ປ້ອນເມືອງ..."
                                                            required="" name="la_dis">
                                                    </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text" class="form-control la_pro"
                                                            value="<?= $collateral_land['la_pro']; ?>"
                                                            id="validationCustom01" placeholder="ປ້ອນແຂວງ..."
                                                            required="" value="" name="la_pro">
                                                    </div>
                                                </div>
                                                <div class="col-xl-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text" class="form-control la_name"
                                                            value="<?= $collateral_land['la_name']; ?>"
                                                            id="validationCustom01"
                                                            placeholder="ປ້ອນຊື່ຜູ້ອອກໃບຕາດີນ..." required=""
                                                            name="la_name">
                                                    </div>
                                                    <label class="col-form-label"
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text" class="form-control la_original_price"
                                                            value="<?= number_format($collateral_land['la_original_price']); ?> ກີບ"
                                                            id="validationCustom01" placeholder="0.00" required=""
                                                            name="la_original_price">
                                                    </div>
                                                    <label class="col-form-label"
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text" class="form-control la_market_price"
                                                            value="<?= number_format($collateral_land['la_market_price']); ?> ກີບ"
                                                            id="validationCustom01" placeholder="0.00" required=""
                                                            name="la_market_price">
                                                    </div>
                                                    <label class="col-form-label"
                                                    ...
                                                    <div class="input-group">
                                                        <input
                                                            style="border: none; font-size: 18px; margin-left: -1.3rem;"
                                                            type="text" class="form-control la_market_price"
                                                            value="<?= number_format($collateral_land['la_pham']); ?> ກີບ"
                                                            id="validationCustom01" placeholder="0.00" required=""
                                                            name="la_market_price">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <input style="height: 200px; border: none; font-size: 18px; margin-left: -1.3rem;"
                                        type="text" value="<?= $collateral_land['la_explain']; ?>" class="form-control"
                                        id="validationCustom01" name="la_explain">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class=" row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">ຮູບພາບແຜນທີ່ ທີ່ຕັ້ງຊັບສົມບັດ ແລະ ຮູບພາບປະກອບຊັບສົມບັດ</h4>
                                    <span class="text-danger">*</span>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <img width="100%" id="preview_image_location"
                                                src="collateral_map/<?php echo $collateral_land['la_map0']; ?>" alt="">
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <img width="100%" id="previewImg"
                                                        src="collateral_images/<?php echo $collateral_land['la_image0']; ?>"
                                                        alt="">

                                                    <img style="margin-top: 1rem;" width="100%" id="previewImg1"
                                                        src="collateral_images/<?php echo $collateral_land['la_image1']; ?>"
                                                        alt="">
                                                </div>
                                                <div class="col-lg-6">
                                                    <img width="100%" id="previewImg2"
                                                        src="collateral_images/<?php echo $collateral_land['la_image2']; ?>"
                                                        alt="">
                                                    <img style="margin-top: 1rem;" width="100%" id="previewImg3"
                                                        src="collateral_images/<?php echo $collateral_land['la_image3']; ?>"
                                                        alt="">
                                                </div>
                                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input style="border: none; font-size: 18px; margin-left: -1.3rem;" type="text"
                                            class="form-control la_doc_name"
                                            value="<?= $collateral_land['la_doc_name']; ?>" name="la_doc_name"
