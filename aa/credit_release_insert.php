                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="" id="collateral_insert" class="needs-validation" novalidate=""
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-xl-3">
                                                                        <label class="col-form-label"
                                                                            for="validationCustom06">ລະຫັດການປ່ອຍສິນເຊື່ອ
                                                                            <span class="text-danger">*</span>
                                                                        </label>
                                                                        <div class="input-group">
                                                                            <span class="input-group-text"
                                                                                id="inputGroupPrepend">#</span>
                                                                            <input style="background: #e8f0fe;" type="text"
                                                                                class="form-control cr_id"
                                                                    ...
                                                                    <div class="col-xl-3">
                                                                        ...
                                                                        <div class="input-group">
                                                                            <span class="input-group-text"
                                                                                id="inputGroupPrepend">#</span>
                                                                            <input type="text"
                                                                                class="form-control lg_runing_id"
                                                                                id="validationCustom01"
                                                                                placeholder="ປ້ອນເລກທີ່ສັນຍາເງິນກູ້..."
                                                                                required="" name="lg_runing_id">
                                                                        </div>
                                                                        ...
                                                                        <input type="hidden" class="form-control cus_id"
                                                                            id="validationCustom01" placeholder=""
                                                                            required="" name="cus_id">
                                                                        <input type="hidden" class="form-control cus_runing"
                                                                            id="validationCustom01" placeholder=""
                                                                            required="" name="cus_runing">

                                                                        <label class="col-form-label"
                                                                            for="validationCustom06">ຊື່ ແລະ ນາມສະກຸນ
                                                                            <span class="text-danger">*</span>
                                                                        </label>
                                                                        <div class="input-group">
                                                                            <span class="input-group-text"
                                                                                id="inputGroupPrepend">#</span>
                                                                            <input style="background: #e8f0fe;" type="text"
                                                                                class="form-control cus_fname"
                                                                                id="validationCustom01"
                                                                                placeholder="ປ້ອນຊື່ ແລະ ນາມສະກຸນ..."
                                                                                required="" name="cus_fname" readonly>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-xl-3">
                                                                        <label class="col-form-label"
                                                                            for="validationCustom06">ສັນຍາເງິນກູ້ລົງວັນທີ
                                                                            <span class="text-danger">*</span>
                                                                        </label>
                                                                        <div class="input-group">
                                                                            <span class="input-group-text"
                                                                                id="inputGroupPrepend">#</span>
                                                                            <input type="date"
                                                                                class="form-control cr_lg_date"
                                                                                id="validationCustom01"
                                                                                placeholder="ປ້ອນລົງວັນທີ..." value=""
                                                                                required="" name="cr_lg_date" readonly>
                                                                        </div>
                                                                        <label class="col-form-label"
                                                                            for="validationCustom06">ເງິນກູ້ໄລຍະເວລາ
                                                                            <span class="text-danger">*</span>
                                                                        </label>
                                                                        <div class="input-group">
                                                                            <span class="input-group-text"
                                                                                id="inputGroupPrepend">#</span>
                                                                            <input type="hidden"
                                                                                class="form-control cr_set_month"
                                                                                id="validationCustom01" value=""
                                                                                placeholder="ເງິນກູ້ໄລຍະເວລາ.." required=""
                                                                                name="cr_set_month" readonly>
                                                                            <input type="text"
                                                                                class="form-control cr_set_months"
                                                                                id="validationCustom01" value=""
                                                                                placeholder="ເງິນກູ້ໄລຍະເວລາ.." required=""
                                                                                name="cr_set_months" readonly>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-xl-3">
                                                                        <label class="col-form-label"
                                                                            for="validationCustom06">ວົງເງິນອະນຸມັດ
                                                                            <span class="text-danger">*</span>
                                                                        </label>
                                                                        <div class="input-group">
                                                                            <span class="input-group-text"
                                                                                id="inputGroupPrepend">#</span>
                                                                            <input type="hidden"
                                                                                class="form-control cr_ap_mounnt"
                                                                                id="validationCustom01" value=""
                                                                                placeholder="ຈຳນວນເງິນ..." required=""
                                                                                name="cr_ap_mounnt" readonly>
                                                                            <input type="text"
                                                                                class="form-control cr_ap_mounnt1"
                                                                                id="validationCustom01" value=""
                                                                                placeholder="ຈຳນວນເງິນ..." required=""
                                                                                name="cr_ap_mounnt1" readonly>
                                                                        </div>
                                                                        <label class="col-form-label"
                                                                            for="validationCustom06">ຈຳນວນເງິນເປັນຕົວໜັງສື
                                                                            <span class="text-danger">*</span>
                                                                        </label>
                                                                        <div class="input-group">
                                                                            <span class="input-group-text"
                                                                                id="inputGroupPrepend">#</span>
                                                                            <input type="text"
                                                                                class="form-control cr_ap_amount_text"
                                                                                id="validationCustom01" value=""
                                                                                placeholder="ປ້ອນຈຳນວນນວນເງິນເປັນຕົວໜັງສື..."
                                                                                required="" name="cr_ap_amount_text">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-xl-3">
                                                                        <label class="col-form-label"
                                                                            for="validationCustom06">ອັດຕາດອກເບ້ຍ / ເດືອນ
                                                                            <span class="text-danger">*</span>
                                                                        </label>
                                                                        <div class="input-group">
                                                                            <span class="input-group-text"
                                                                                id="inputGroupPrepend">#</span>
                                                                            <input type="hidden"
                                                                                class="form-control cr_interest"
                                                                                id="validationCustom01" value=""
                                                                                placeholder="ອັດຕາດອກເບ້ຍ / ເດືອນ..."
                                                                                required="" name="cr_interest" readonly>
                                                                            <input type="text"
                                                                                class="form-control cr_interests"
                                                                                id="validationCustom01" value=""
                                                                                placeholder="ອັດຕາດອກເບ້ຍ / ເດືອນ..."
                                                                                required="" name="cr_interests" readonly>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
