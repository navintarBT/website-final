                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a
                                href="javascript:void(0)"></a>ລາຍງານຂໍ້ມູນຫຼັບຊັບຄ້ຳປະກັນອື່ນໆທີມີສະຖານະວ່າງ</li>
                    </ol>
                </div>
                <!-- row -->
                            ...
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white text-end">
                                        ...
                                        <h3 class="text-white">
                                            <?php echo number_format($show_cus_total_expenses[0]) ?> ກີບ
                                        </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white text-end">
                                        ...
                                        <h3 class="text-white">
                                            <?php echo number_format($show_cus_total_expensesmin[0]) ?> ກີບ
                                        </h3>
                                    </div>
                                </div>
                            </div>
