        ...
        if ($upload != '') {
            ...
            if ($typefile == '.pdf') {
                ...
                if ($cus_runings <> 0) {
                    ...
                    $sql = $conn->prepare("INSERT INTO credit_release(cr_running_id,cr_money_circle,cr_interest,cr_release_date,cr_loan_id,cr_set_mouth,cr_doc_name,cr_doc,cr_date,cus_id,cus_fname,cus_runing,user_id) 
                    VALUES(:cr_running_id,:cr_money_circle,:cr_interest,:cr_release_date,:cr_loan_id,:cr_set_mouth,:cr_doc_name,'$newname',:cr_date,:cus_id,:cus_fname,:cus_runing,:user_id)");
                                                        ...
                                                        <div class="col-xl-12">
                                                            <div class="row">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input style="background: #e8f0fe;" type="text" class="form-control cr_running_id" id="validationCustom01" value="<?php echo $number ?>" required="" name="cr_running_id" readonly>
                                                                </div>
                                                    ...
                                                    <div class="mb-1 row">
                                                        <div class="col-xl-12">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input style="background: #FDEBD0;"  type="text" class="form-control cus_runing" id="validationCustom01" value="" placeholder="ປ້ອນເລກທີ່ສັນຍາ..." required="" name="cus_runing">
                                                            </div>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                            <input style="background: #e8f0fe;" type="text" class="form-control ca_playment" id="validationCustom01" value="" placeholder="ງວດທີ່..." required="" name="ca_playment">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                            <input style="background: #e8f0fe;" type="date" class="form-control ca_playment" id="validationCustom01" value="" placeholder="ງວດທີ່..." required="" name="ca_playment">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                    ...
                                                    <div class="col-lg-3">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                            <input style="background: #e8f0fe;" type="text" class="form-control ca_playment" id="validationCustom01" placeholder="ປ້ອນຈຳນວນມື້ເກິນກຳນົດ..." required="" name="ca_playment">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                            <input style="background: #FDEBD0;" type="text" class="form-control ca_playment" id="validationCustom01" value="" placeholder="0.00..." required="" name="ca_playment">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                    ...
                                                    <div class="col-lg-3">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                            <input style="background: #e8f0fe;" type="text" class="form-control ca_playment" id="validationCustom01" placeholder="ປ້ອນຄ່າປັບໃຫມ່..." required="" name="ca_playment">
                                                        </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            ...
                                                            <div class="input-group">
                                                                <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                                <input style="background: #e8f0fe;" type="text" class="form-control ca_playment" id="validationCustom01" value="" placeholder="0.00..." required="" name="ca_playment">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <label class="col-form-label" for="validationCustom06">ດອກເບ້ຍ
