...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>ລາຍງານຈຳນວນການເຮັດສັນຍາພາຍໃນປີນີ້</title>
                    ...
                    <nav class="navbar navbar-expand">
                        <div class="collapse navbar-collapse justify-content-between">
                            <div class="header-left">
                                ...
                                ລາຍງານຈຳນວນການເຮັດສັນຍາພາຍໃນປີນີ້
                                </div>
                            </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:void(0)">ລາຍງານຈຳນວນການເຮັດສັນຍາພາຍໃນປີນີ້</a></li>
                        </ol>
                    </div>
                    <!-- row -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">ລາຍງານຈຳນວນການເຮັດສັນຍາພາຍໃນປີນີ້</h4>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example" class="display" style="min-width: 845px">
                                            ...
                                            <tbody>
                                                <?php
                                                $stmt = $conn->query("select * from loan_agreement where year(lg_date_in)=year(curdate()) and year(lg_date_in)=year(curdate())");
                                                $stmt->execute();
                                                $users = $stmt->fetchAll();
