...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>ລາຍງານຂໍ້ມູນການປ່ອຍສິນເຊື່ອພາຍໃນປີນີ້</title>
                    ...
                    <nav class="navbar navbar-expand">
                        <div class="collapse navbar-collapse justify-content-between">
                            <div class="header-left">
                                ...
                                ລາຍງານຂໍ້ມູນການປ່ອຍສິນເຊື່ອພາຍໃນປີນີ້
                                </div>
                            </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:void(0)">ລາຍງານຂໍ້ມູນການປ່ອຍສິນເຊື່ອພາຍໃນປີນີ້</a></li>
                        </ol>
                    </div>
                    <!-- row -->
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example" class="display" style="min-width: 845px">
                                            ...
                                            <tbody>
                                                <?php
                                                $stmt = $conn->query("select * from credit_release where year(cr_date_in)=year(curdate()) and year(cr_date_in)=year(curdate())");
                                                $stmt->execute();
                                                $users = $stmt->fetchAll();
