                            ...
                            <div class="card-body">
                                <form action="" id="collateral_insert" class="needs-validation" novalidate="" method="post" enctype="multipart/form-data">
                                    ...
                                    if (isset($_GET['id'])) {
                                        ...
                                        $stmt = $conn->query("SELECT * FROM payment WHERE pm_id = '$id' ");
                                        $stmt->execute();
                                        $data = $stmt->fetch();
                                    ...
                                    <div class=" row">
                                                        ...
                                                        <div class="col-xl-12">
                                                            <div class="row">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input style="border: none; margin-left: -1.3rem; font-size: 18px" type="text" class="form-control pm_id" id="validationCustom01" value="<?php echo $data['pm_id'] ?>" required="" name="pm_id" readonly>
                                                                </div>
                                                    ...
                                                    <div class="mb-1 row">
                                                        <div class="col-xl-12">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input style="border: none; margin-left: -1.3rem; font-size: 18px"  type="text" class="form-control lg_runing_id" id="validationCustom01" value="<?= $data['lg_runing_id']; ?>" placeholder="ປ້ອນເລກທີ່ສັນຍາ..." required="" name="lg_runing_id">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-xl-9">
                                            <div class="card">
                                                ...
                                                <div class="me-3 mb-3">
                                                        <p class="fs-14 mb-1">ງອດທີ່</p>
                                                        <span class="text-black fs-16"><?= $data['pm_itm']; ?></span>
                                                    </div>
                                                    <div class="me-3 mb-3">
                                                    ...
                                                    <div class="me-3 mb-3">
                                                        <p class="fs-14 mb-1">ຈຳນວນເງິນຕົ້ນທີ່ຊຳລະ</p>
                                                        <span class="text-black fs-16"><?= number_format($data['pm_pcp']);  ?> ກີບ</span>
                                                    </div>
                                                    <div class="mb-3 me-3">
                                                        <p class="fs-14 mb-1">ຈຳນວນດອກເບ້ຍທີ່ຊຳລະ</p>
                                                        <span class="text-num text-black fs-16"><?= number_format($data['pm_itr']); ?> ກີບ</span>
                                                    </div>
                                                    <div class="mb-3 me-3">
                                                        <p class="fs-14 mb-1">ເງິນຕົ້ນຍົກຍ້າຍ</p>
                                                        <span class="text-num text-black fs-16"><?= number_format($data['pm_tf_pcp']); ?> ກີບ</span>
                                                    </div>
                                                    <div class="mb-3 me-3">
                                                        <p class="fs-14 mb-1">ດອກເບ້ນຍົກຍ້າຍ</p>
                                                        <span class="text-num text-black fs-16"><?= number_format($data['pm_tf_itr']); ?> ກີບ</span>
                                                    </div>
                                                    <div class="mb-3 me-3">
                                                        <h5 class="fs-20 text-black font-w500">ເງິນຕົ້ນ+ດອດເບ້ຍທີ່ຊຳລະ</h5>
                                                        <span class="text-num text-black fs-36 font-w500"><?= number_format($data['pm_pcp_itr']); ?> ກີບ</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class=" row">
                                        <div class="col-lg-6">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h4 class="card-title">ຫຼັກຖານການຊຳລະ</h4>
                                                </div>
                                                <div style="margin-top: 0rem;" class="card-body">
                                                    <img src="payment_insert_image/<?php echo $data['pm_images']; ?>" height="500" while="" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
