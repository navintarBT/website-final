...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>ລາຍງານຂໍ້ມູນລູກຄ້າທັງໝົດພາຍໃນເດືອນນີ້</title>
                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            ...
                            ລາຍງານຂໍ້ມູນລູກຄ້າທັງໝົດພາຍໃນເດືອນນີ້
                            </div>
                        </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">ລາຍງານຂໍ້ມູນລູກຄ້າທັງໝົດພາຍໃນເດືອນນີ້</a></li>
                    </ol>
                </div>
                <!-- row -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">ລາຍງານຂໍ້ມູນລູກຄ້າທັງໝົດພາຍໃນເດືອນນີ້</h4>
                                <a href="customer_insert.php" style="cursor: pointer;" class="btn me-2 btn-primary"><i class="bi bi-person-plus-fill me-2"></i>ບັນທືກລູກຄ້າ</a>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = mysqli_query($conns, "select * from customers where month(cus_date_in)=month(curdate()) and year(cus_date_in)=year(curdate())");
                                            $a = 1;
