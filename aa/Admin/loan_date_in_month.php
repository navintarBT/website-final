...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>ລາຍງານຈຳນວນການເຮັດສັນຍາພາຍໃນເດືອນນີ້</title>
    ...
    if (isset($_REQUEST['delete'])) {
        ...
        $delete_stmt = $conn->prepare('DELETE FROM credit_analysis WHERE ca_id = :id');
        $delete_stmt->bindParam(':id', $id);
        $delete_stmt->execute();

        $select_cus_id = $conn->prepare('SELECT cus_id FROM credit_analysis WHERE ca_id = :id');
        $select_cus_id->bindParam(':id', $id);
        $select_cus_id->execute();
        $row_cus_id = $select_cus_id->fetch(PDO::FETCH_ASSOC);

        $cus_ages = 0;
        $cus_nationalitys = "";
        $cus_jobs = "";

        $conn->prepare("UPDATE customers SET 
                cus_age = :cus_age,
                cus_nationality = :cus_nationality,  
                cus_job = :cus_job WHERE cus_id = :cus_id");
        $up->bindParam(":cus_id", $row_cus_id);
        $up->bindParam(":cus_age", $cus_ages);
        $up->bindParam(":cus_nationality", $cus_nationalitys);
        $up->bindParam(":cus_job", $cus_jobs);
        $up->execute();
    }
    ?>
...
<body>
    ...
    $sql_count_lg_id = mysqli_query($conns, "select count(lg_id) from loan_agreement");
    $show_count_lg_id = mysqli_fetch_array($sql_count_lg_id);

    $sql_count_la_status0 = mysqli_query($conns, "select count(lg_id) from loan_agreement where lg_status = 1");
    $show_count_la_status0 = mysqli_fetch_array($sql_count_la_status0);

    $sql_count_la_status1 = mysqli_query($conns, "select count(lg_id) from loan_agreement where lg_status = 2");
    $show_count_la_status1 = mysqli_fetch_array($sql_count_la_status1);

    $sql_cus_total_expenses = mysqli_query($conns, "select lg_capital_plus_interest from loan_agreement where lg_capital_plus_interest = (select max(lg_capital_plus_interest) from credit_analysis)");
    $show_cus_total_expenses = mysqli_fetch_array($sql_cus_total_expenses);

    $sql_cus_total_expensesmin = mysqli_query($conns, "select lg_capital_plus_interest from loan_agreement where lg_capital_plus_interest = (select min(lg_capital_plus_interest) from credit_analysis)");
    $show_cus_total_expensesmin = mysqli_fetch_array($sql_cus_total_expensesmin);

    $sql_count_cus_date_in = mysqli_query($conns, "select count(lg_id) from loan_agreement where lg_date_in = curdate()");
    $show_count_cus_date_in = mysqli_fetch_array($sql_count_cus_date_in);

    $sql_count_cus_date_in_week = mysqli_query($conns, "select count(lg_id) from loan_agreement where week(lg_date_in)=week(curdate()) and year(lg_date_in)=year(curdate())");
    $show_count_cus_date_in_week = mysqli_fetch_array($sql_count_cus_date_in_week);

    $sql_count_cus_date_in_month = mysqli_query($conns, "select count(lg_id) from loan_agreement where month(lg_date_in)=month(curdate()) and year(lg_date_in)=year(curdate())");
    $show_count_cus_date_in_month = mysqli_fetch_array($sql_count_cus_date_in_month);

    $sql_count_cus_date_in_year = mysqli_query($conns, "select count(lg_id) from loan_agreement where year(lg_date_in)=year(curdate()) and year(lg_date_in)=year(curdate())");
                    ...
                    <nav class="navbar navbar-expand">
                        <div class="collapse navbar-collapse justify-content-between">
                            <div class="header-left">
                                ...
                                ລາຍງານຈຳນວນການເຮັດສັນຍາພາຍໃນເດືອນນີ້
                                </div>
                            </div>
            ...
            <div class="content-body ">
                <div class="container-fluid">
                    ...
                    <div class="row page-titles">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active"><a href="javascript:void(0)"></a>ການເຮັກສັນຍາ</li>
                            <li class="breadcrumb-item"><a href="javascript:void(0)">ລາຍງານຈຳນວນການເຮັດສັນຍາພາຍໃນເດືອນນີ້</a></li>
                        </ol>
                    </div>
                    <!-- row -->
                            ...
                            <div class="card bg-warning invoice-card">
                                <div class="card-body d-flex">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-white fs-18">ຈຳນວນສັນຍາທັງໝົດ</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card bg-success invoice-card">
                                <div class="card-body d-flex">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-white fs-18">ຈຳນວນສັນຍາທີ່ເປິດແລ້ວ</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-xxl-3 col-sm-6">
                            <div class="card bg-info invoice-card">
                                <div class="card-body d-flex">
                                    ...
                                    <div>
                                        <h2 class="text-white invoice-num"><?php echo $show_count_la_status1[0] ?> ຄົນ</h2>
                                        <span class="text-white fs-18">ຈຳນວນສັນຍາທີ່ປິດແລ້ວ</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-xxl-6 col-lg-6 col-sm-6">
                            <a href="loan_date_in.php">
                                    ...
                                    <div class="card-body p-4">
                                        <div class="media">
                                            ...
                                            <div class="media-body text-white">
                                                <p class="mb-1 fs-18">ຈຳນວນການເຮັດສັນຍາພາຍໃນມື້ນີ້</p>
                                                <h4 class="text-white"><?php echo $show_count_cus_date_in[0] ?> ລາຍການ</h4>
                                                <small>
                                                    <p>ພາຍໃນໄລຍະເວລາ 24 ຊົ່ວໂມງ</p>
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="widget-stat card bg-danger">
                                    <div class="card-body  p-4">
                                        <div class="media">
                                            ...
                                            <div class="media-body text-white">
                                                <p class="mb-1 fs-18">ຈຳນວນການເຮັດສັນຍາພາຍໃນອະທິດນີ້</p>
                                ...
                                <div class="widget-stat card bg-warning">
                                    <div class="card-body p-4">
                                        <div class="media">
                                            ...
                                            <div class="media-body text-white">
                                                <p class="mb-1 fs-18">ຈຳນວນການເຮັດສັນຍາພາຍໃນເດືອນນີ້</p>
                                ...
                                <div class="widget-stat card bg-secondary">
                                    <div class="card-body p-4">
                                        <div class="media">
                                            ...
                                            <div class="media-body text-white">
                                                <p class="mb-1 fs-18">ຈຳນວນການເຮັດສັນຍາພາຍໃນປີນີ້</p>
                                ...
                                <div class="card-body p-4">
                                    <div class="media">
                                        ...
                                        <div class="media-body text-white text-end">
                                            <p class="mb-1 fs-18">ສັນຍາທີ່ມູນຄ້າຫຼາຍທີ່ສຸດ</p>
                                            <h3 class="text-white"><?php echo number_format($show_cus_total_expenses[0]) ?> ກີບ</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style="background: #2980B9;" class="widget-stat card">
                                <div class="card-body p-4">
                                    <div class="media">
                                        ...
                                        <div class="media-body text-white text-end">
                                            <p class="mb-1 fs-18">ສັນຍາທີ່ມີມູນຄ້າໜ່ອຍທີ່ສຸດ</p>
                                            <h3 class="text-white"><?php echo number_format($show_cus_total_expensesmin[0]) ?> ກີບ</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">ລາຍງານຈຳນວນການເຮັດສັນຍາພາຍໃນເດືອນນີ້</h4>
                                    <a href="loan_agreement_insert.php" class="btn me-2 btn-primary submit"><i class="bi bi-person-plus-fill me-2"></i>ບັນທຶກສັນຍາເງິນກູ້</a>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example" class="display" style="min-width: 845px">
                                            ...
                                            <tbody>
                                                <?php
                                                $stmt = $conn->query("select * from loan_agreement where month(lg_date_in)=month(curdate()) and year(lg_date_in)=year(curdate())");
                                                $stmt->execute();
                                                $users = $stmt->fetchAll();
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['lg_set_month']; ?> ເດືອນ</td>
                                                        <td><?php echo $row['lg_interest']; ?> %</td>
                                                        <td><?php echo number_format($row['lg_amount_releaseds']); ?> LAK</td>
                                                        <td><?php echo number_format($row['lg_total_interest']); ?> LAK</td>
                                                        <td><?php echo number_format($row['lg_capital_plus_interest']); ?> LAK</td>
                                                        <td>
                                                            <?php
                                                            if ($row['lg_status'] == 1) {
                                                                echo "
                ...
                Swal.fire({
                    ...
                    preConfirm: function() {
                        return new Promise(function(resolve) {
                            $.ajax({
                                    url: 'credit_analysis_select.php',
                                    type: 'GET',
                                    data: 'delete=' + userId,
                                })
                                .done(function() {
