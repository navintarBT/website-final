...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>ລາຍງານຂໍ້ມູນຫຼັບຊັບຄ້ຳປະກັນ ລົດຈັກ-ລົດໃຫຍ່</title>
...
<body>
    ...
    if($show_cus_total_expenses[0] == ""){
        ...
        $show_expense = $show_cus_total_expenses[0];
    }
    ...
    if($show_cus_total_expensesmin[0]){
        ...
        $show_expensesmin = $show_cus_total_expensesmin[0];
    }
    ?>
    <!--*******************
        Preloader start
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            <div class="dashboard_bar">
                                ຫຼັບຊັບຄ້ຳປະກັນ ລົດຈັກ-ລົດໃຫຍ່
                            </div>
                        </div>
        ...
        <div class="content-body ">
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a href="javascript:void(0)"></a>ລາຍງານຂໍ້ມູນຫຼັບຊັບຄ້ຳປະກັນ ລົດຈັກ-ລົດໃຫຍ່</li>
                    </ol>
                </div>
                <!-- row -->
                            ...
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white text-end">
                                        ...
                                        <h3 class="text-white"><?php echo number_format($show_expense) ?> ກີບ</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white text-end">
                                        ...
                                        <h3 class="text-white"><?php echo number_format($show_expensesmin) ?> ກີບ</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <?php
                                            $stmt = $conn->query("SELECT * FROM collateral_car");
                                            $stmt->execute();
                                            $users = $stmt->fetchAll();
