...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>ລາຍງານຂໍ້ມູນລູກຄ້າທັງໝົດປີນີ້</title>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">ລາຍງານຂໍ້ມູນລູກຄ້າທັງໝົດປີນີ້</a></li>
                    </ol>
                </div>
                <!-- row -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">ລາຍງານຂໍ້ມູນລູກຄ້າທັງໝົດປີນີ້</h4>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = mysqli_query($conns, "select * from customers where year(cus_date_in)=year(curdate()) and year(cus_date_in)=year(curdate())");
                                            $a = 1;
