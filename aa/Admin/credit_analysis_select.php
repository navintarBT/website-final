...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>ລາຍງານຂໍ້ມູນການວິເຄາະສິນເຊື່ອ</title>
...
<?php
        ...
        $sql_count_lg_id= mysqli_query($conns, "select count(ca_id) from credit_analysis");
        $show_count_lg_id = mysqli_fetch_array($sql_count_lg_id);

        $sql_count_la_status0= mysqli_query($conns, "select count(ca_id) from credit_analysis where ca_status = 0");
        $show_count_la_status0 = mysqli_fetch_array($sql_count_la_status0);

        $sql_count_la_status1= mysqli_query($conns, "select count(ca_id) from credit_analysis where ca_status = 1");
        $show_count_la_status1 = mysqli_fetch_array($sql_count_la_status1);

        $sql_count_la_status2= mysqli_query($conns, "select count(ca_id) from credit_analysis where ca_status = 2");
        $show_count_la_status2 = mysqli_fetch_array($sql_count_la_status2);

        $sql_cus_total_expenses = mysqli_query($conns, "select ca_amount_released from credit_analysis where ca_amount_released = (select max(ca_amount_released) from credit_analysis)");
        $show_cus_total_expenses = mysqli_fetch_array($sql_cus_total_expenses);
        if($show_cus_total_expenses[0] == ""){
            $shohw_total_income_max = "0";
        }else{
            $shohw_total_income_max = $show_cus_total_expenses[0];
        }

        $sql_cus_total_expensesmin = mysqli_query($conns, "select ca_amount_released from credit_analysis where ca_amount_released = (select min(ca_amount_released) from credit_analysis)");
        $show_cus_total_expensesmin = mysqli_fetch_array($sql_cus_total_expensesmin);
        if($show_cus_total_expensesmin[0] == ""){
            $shohw_total_income_min = "0";
        }else{
            $shohw_total_income_min = $show_cus_total_expensesmin[0];
        }
            ...
            <div class="content-body ">
                <div class="container-fluid">
                    ...
                    <div class="row page-titles">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active"><a href="javascript:void(0)"></a>ວິເຄາະສິນເຊື່ອ</li>
                            <li class="breadcrumb-item"><a href="javascript:void(0)">ລາຍງານຂໍ້ມູນວິເຄາະສິນເຊື່ອ</a></li>
                        </ol>
                    </div>
                    <!-- row -->
                            ...
                            <div class="card bg-warning invoice-card">
                                <div class="card-body d-flex">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-white fs-18">ການວິເຄາະສິນເຊື່ອທັງໝົດ</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card bg-success invoice-card">
                                <div class="card-body d-flex">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-white fs-18">ການວິເຄາະສິນເຊື່ອທີ່ວ່າງ</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card bg-info invoice-card">
                                <div class="card-body d-flex">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-white fs-18">ການວິເຄາະສິນເຊື່ອທີ່ນຳໃຊ້</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card bg-secondary invoice-card">
                                <div class="card-body d-flex">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-white fs-18">ການວິເຄາະສິນເຊື່ອທີ່ປິດສັນຍາແລ້ວ</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body p-4">
                                    <div class="media">
                                        ...
                                        <div class="media-body text-white text-end">
                                            <p class="mb-1 fs-18">ການວິເຄາະສິນເຊື່ອທີ່ມູນຄ້າຫຼາຍທີ່ສຸດ</p>
                                            <h3 class="text-white"><?php echo number_format($shohw_total_income_max) ?> ກີບ</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style="background: #2980B9;" class="widget-stat card">
                                <div class="card-body p-4">
                                    <div class="media">
                                        ...
                                        <div class="media-body text-white text-end">
                                            <p class="mb-1 fs-18">ການວິເຄາະສິນເຊື່ອທີ່ມີມູນຄ້າໜ່ອຍທີ່ສຸດ</p>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">ຕາຕະລາງລາຍລະອຽດຂໍ້ມູນການວິເຄາະສິນເຊື່ອ</h4>
                                        ...
                                        <table id="example" class="display" style="min-width: 845px">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>ສະເໜີຂໍກູ້ຢຶມເງິນ</th>
                                                    <th>ຈຳນວນປ່ອຍຕົວຈິງ</th>
                                                    <th>ກຳນົດເວລາ / ເດືອນ</th>
                                                    <th>ອັດຕາດອກເບ້ຍ% / ເດືອນ</th>
                                                    <th>ອັດຕາສ່ວນເງິນກູ້ຕໍ່ຊັບສົມບັດຄ້ຳປະກັນ %</th>
                                                    <th>ສະຖານະ</th>
                                                    <th>ເມນູ</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                $stmt = $conn->query("SELECT * FROM credit_analysis");
                                                $stmt->execute();
                                                $users = $stmt->fetchAll();
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['ca_runing_id']; ?></td>
                                                        <td><?php echo $row['cus_fname']; ?></td>
                                                        <td><?php echo number_format($row['ca_amount_offered']); ?> LAK</td>
                                                        <td><?php echo number_format($row['ca_amount_released']); ?> LAK</td>
                                                        <td><?php echo $row['ca_set_month']; ?> ເດືອນ</td>
                                                        <td><?php echo $row['ca_interest']; ?> %</td>
                                                        <td><?php echo $row['ca_loan_to_collateral']; ?> %</td>
                                                        <td>
                                                            <?php
                                                            if ($row['ca_status'] == 0) {
                                                                echo "
                                                        ...
                                                        <td>
                                                            <div class="btn-group dropstart mb-1">
                                                                ...
                                                                <div style="background: #FDFEFE;" class="dropdown-menu">
                                                                    ...
                                                                    <hr>
                                                                    <a class="dropdown-item" href="credit_analysis_doc.php?id=<?php echo $row['ca_id']; ?>">ເອກກະສານວິເຄາະສິນເຊື່ອ</a>
                                                                    <hr>
                                                                    <a class="dropdown-item button_edit" href="credit_analysis_update.php?id=<?php echo $row['ca_id']; ?> ">ແກ້ໄຂຂໍ້ມູນ</a>
                                                                    <a data-ca_id="<?= $row['ca_id']; ?>" href="?delete=<?= $row['ca_id']; ?>" class="dropdown-item delete-btn">ລົບຂໍ່ມູນ</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
