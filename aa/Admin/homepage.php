				...
				<div class="container-fluid">
					...
					<div class="col-lg-12">
                                ...
                                <div class="profile-info">
									...
									<div class="profile-details">
										<div class="profile-name px-3 pt-2">
											...
											<p><?php echo $_SESSION['user_satus']; ?></p>
										</div>
						...
						<div style="cursor: pointer;" class="col-xl-3 col-xxl-3 col-sm-6">
							<a href="customer_select_history.php">
						...
						<div style="cursor: pointer;" class="col-xl-3 col-xxl-3 col-sm-6">
							<a href="customer_show_status0.php">
								<div class="card bg-success invoice-card">
									<div class="card-body d-flex">
										...
										<div>
											...
											<span class="text-white fs-18">ລູກຄ້າບໍ່ມີສັນຍາ</span>
										</div>
									</div>
								</div>
							</a>
						...
						<div style="cursor: pointer;" class="col-xl-3 col-xxl-3 col-sm-6">
							<a href="customer_cus_status1.php">
								<div class="card bg-info invoice-card">
									<div class="card-body d-flex">
										...
										<div>
											...
											<span class="text-white fs-18">ລູກຄ້າເປິດສັນຍາ</span>
										</div>
									</div>
								</div>
							</a>
						...
						<div style="cursor: pointer;" class="col-xl-3 col-xxl-3 col-sm-6">
							<a href="customer_cus_status2.php">
						...
						<div class="col-xl-3 col-xxl-6 col-lg-6 col-sm-6">
							<a href="customer_cus_date_in.php">
									...
									<div class="card-body p-4">
										<div class="media">
											...
											<div class="media-body text-white">
												<p class="mb-1 fs-18">ຈຳນວນລູກຄ້າພາຍໃນມື້ນີ້</p>
												<h3 class="text-white"><?php echo $show_count_cus_date_in[0] ?> ຄົນ</h3>
						...
						<div class="col-xl-3 col-xxl-6 col-lg-6 col-sm-6">
							<a href="customer_date_in_week.php">
								<div class="widget-stat card bg-danger">
									<div class="card-body  p-4">
										<div class="media">
											...
											<div class="media-body text-white">
												<p class="mb-1 fs-18">ຈຳນວນລູກຄ້າພາຍໃນອະທິດນີ້</p>
												<h3 class="text-white"><?php echo $show_count_cus_date_in_week[0] ?> ຄົນ</h3>
						...
						<div class="col-xl-3 col-xxl-6 col-lg-6 col-sm-6">
							<a href="customer_date_in_month.php">
								<div class="widget-stat card bg-warning">
									<div class="card-body p-4">
										<div class="media">
											...
											<div class="media-body text-white">
												<p class="mb-1 fs-18">ຈຳນວນລູກຄ້າພາຍໃນເດືອນນີ້</p>
												<h3 class="text-white"><?php echo $show_count_cus_date_in_month[0] ?> ຄົນ</h3>
						...
						<div class="col-xl-3 col-xxl-6 col-lg-6 col-sm-6">
							<a href="customer_cus_date_in_year.php">
								<div class="widget-stat card bg-secondary">
									<div class="card-body p-4">
										<div class="media">
											...
											<div class="media-body text-white">
												<p class="mb-1 fs-18">ຈຳນວນລູກຄ້າພາຍໃນປີນີ້</p>
												<h3 class="text-white"><?php echo $show_count_cus_date_in_year[0] ?> ຄົນ</h3>
									...
									<div class="card-body p-4">
										<div class="media">
											...
											<div class="media-body text-white">
												...
												<h4 class="text-white"><?php echo $show_count_cus_date_in1[0] ?> ລາຍການ</h4>
									...
									<div class="card-body  p-4">
										<div class="media">
											...
											<div class="media-body text-white">
												...
												<h4 class="text-white"><?php echo $show_count_cus_date_in_week1[0] ?> ລາຍການ</h4>
												<p class="mb-1 fs-18">ລວມເປັນເງິນ</p>
									...
									<div class="card-body p-4">
										<div class="media">
											...
											<div class="media-body text-white">
												...
												<h4 class="text-white"><?php echo $show_count_cus_date_in_month1[0] ?> ລາຍການ</h4>
												<p class="mb-1 fs-18">ລວມເປັນເງິນ</p>
									...
									<div class="card-body p-4">
										<div class="media">
											...
											<div class="media-body text-white">
												...
												<h4 class="text-white"><?php echo $show_count_cus_date_in_year1[0] ?> ລາຍການ</h4>
												<p class="mb-1 fs-18">ລວມເປັນເງິນ</p>
                                    ...
                                    <div class="card-body p-4">
                                        <div class="media">
                                            ...
                                            <div class="media-body text-white">
                                                ...
                                                <h4 class="text-white"><?php echo $show_count_cus_date_in2[0] ?> ລາຍການ</h4>
                                                <p class="mb-1 fs-18">ລວມເປັນເງິນ</p>
                                                <h4 class="text-white"><?php echo number_format($show_sum_pm_pcp_itr1[0]) ?> ກິບ</h4>
                                                <small>
                                    ...
                                    <div class="card-body  p-4">
                                        <div class="media">
                                            ...
                                            <div class="media-body text-white">
                                                ...
                                                <h4 class="text-white"><?php echo $show_count_cus_date_in_week2[0] ?> ລາຍການ</h4>
                                                <p class="mb-1 fs-18">ລວມເປັນເງິນ</p>
                                                <h4 class="text-white"><?php echo number_format($show_sum_pm_pcp_itr_week1[0]) ?> ກິບ</h4>
                                                <small>
                                                    <p>ພາຍໃນໄລຍະເວລາ 7 ມື້</p>
                                                </small>
                                            </div>
                                    ...
                                    <div class="card-body p-4">
                                        <div class="media">
                                            ...
                                            <div class="media-body text-white">
                                                ...
                                                <h4 class="text-white"><?php echo $show_count_cus_date_in_month2[0] ?> ລາຍການ</h4>
                                                <p class="mb-1 fs-18">ລວມເປັນເງິນ</p>
                                                <h4 class="text-white"><?php echo number_format($show_count_pm_pcp_itr_month1[0]) ?> ກິບ</h4>
                                                <small>
                                                    <p>ພາຍໃນໄລຍະເວລາ 30 ມື້</p>
                                                </small>
                                            </div>
                                    ...
                                    <div class="card-body p-4">
                                        <div class="media">
                                            ...
                                            <div class="media-body text-white">
                                                ...
                                                <h4 class="text-white"><?php echo $show_count_cus_date_in_year2[0] ?> ລາຍການ</h4>
                                                <p class="mb-1 fs-18">ລວມເປັນເງິນ</p>
                                                <h4 class="text-white"><?php echo number_format($show_count_pm_pcp_itr_year1[0]) ?> ກິບ</h4>
                                                <small>
                                                    <p>ພາຍໃນໄລຍະເວລາ 365 ມື້</p>
                                                </small>
                                            </div>
                        ...
                        <div class="col-lg-6 col-xxl-6 col-lg-6 col-sm-6">
                            <a href="payment_select.php">
                                <div class="card-bx bg-dark-blue">
                        ...
                        <div class="col-lg-6 col-xxl-6 col-lg-6 col-sm-6">
                            <div style="margin-bottom: 2rem;" class="card-bx bg-dark-blue">
                                <img class="pattern-img" src="images/pattern/pattern11.png" alt="">
                                <div class="card-info text-white">
                                    <img src="images/pattern/circle.png" class="mb-4" alt="">
