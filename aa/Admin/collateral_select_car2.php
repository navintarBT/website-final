...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>ລາຍງານຂໍ້ມູນຫຼັບຊັບຄ້ຳປະກັນອື່ນໆທີມີສະຖານະປິດສັນຍາແລ້ວ</title>
...
<?php
        ...
        if($show_cus_total_expenses == ""){
            ...
            $show_expense = $show_cus_total_expenses;
        }
        ...
        if($show_cus_total_expensesmin){
            ...
            $show_expensesmin = $show_cus_total_expensesmin;
        }
                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            ...
                            ລາຍງານຂໍ້ມູນຫຼັບຊັບຄ້ຳປະກັນອື່ນໆທີມີສະຖານະປິດສັນຍາແລ້ວ
                            </div>
                        </div>
        ...
        <div class="content-body ">
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a href="javascript:void(0)"></a>ລາຍງານຂໍ້ມູນຫຼັບຊັບຄ້ຳປະກັນອື່ນໆທີມີສະຖານະປິດສັນຍາແລ້ວ</li>
                    </ol>
                </div>
                <!-- row -->
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <?php
                                            $stmt = $conn->query("select * from collateral_other where ot_status = 2");
                                            $stmt->execute();
                                            $users = $stmt->fetchAll();
