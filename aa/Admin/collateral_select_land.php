...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>ລາຍງານຂໍ້ມູນຫຼັບຊັບຄ້ຳປະກັນ ທີ່ດິນ-ທີ່ດິນພ້ອມສິ່ງປູກສ້າງ</title>
...
<body>
    ...
    $sql_count_lg_id = mysqli_query($conns, "select count(la_id) from collateral_land");
    $show_count_lg_id = mysqli_fetch_array($sql_count_lg_id);

    $sql_count_la_status0 = mysqli_query($conns, "select count(la_id) from collateral_land where la_status = 0");
    $show_count_la_status0 = mysqli_fetch_array($sql_count_la_status0);

    $sql_count_la_status1 = mysqli_query($conns, "select count(la_id) from collateral_land where la_status = 1");
    $show_count_la_status1 = mysqli_fetch_array($sql_count_la_status1);

    $sql_count_la_status2 = mysqli_query($conns, "select count(la_id) from collateral_land where la_status = 2");
    $show_count_la_status2 = mysqli_fetch_array($sql_count_la_status2);

    $sql_cus_total_expenses = mysqli_query($conns, "select la_pham from collateral_land where la_pham = (select max(la_pham) from collateral_land)");
    $show_cus_total_expenses = mysqli_fetch_array($sql_cus_total_expenses);
    if($show_cus_total_expenses[0] == ""){
        $show_total_expenses = "0";
    }else{
        $show_total_expenses = $show_cus_total_expenses[0];
    }

    $sql_cus_total_expensesmin = mysqli_query($conns, "select la_pham from collateral_land where la_pham = (select min(la_pham) from collateral_land)");
    ...
    if($show_cus_total_expensesmin[0]){
        ...
        $show_total_expensesmin = $show_cus_total_expensesmin[0];
    }    
    ?>
    <!--*******************
        Preloader start
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            <div class="dashboard_bar">
                                ຫຼັບຊັບຄ້ຳປະກັນ ທີ່ດິນ-ທີ່ດິນພ້ອມສິ່ງປູກສ້າງ
                            </div>
                        </div>
        ...
        <div class="content-body ">
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a href="javascript:void(0)"></a>ລາຍງານຂໍ້ມູນຫຼັບຊັບຄ້ຳປະກັນ ທີ່ດິນ-ທີ່ດິນພ້ອມສິ່ງປູກສ້າງ</li>
                    </ol>
                </div>
                <!-- row -->
                ...
                <div class="row invoice-card-row">
                    <div class="col-xl-3 col-xxl-3 col-sm-6">
                        <a href="collateral_select_land.php">
                        <div class="card bg-warning invoice-card">
                            <div class="card-body d-flex">
                                ...
                                <div>
                                    ...
                                    <span class="text-white fs-18">ທີ່ດິນທັງໝົດ</span>
                                </div>
                            </div>
                        </div>
                        </a>
                    ...
                    <div class="col-xl-3 col-xxl-3 col-sm-6">
                        <a href="collateral_la_status0.php">
                            <div class="card bg-success invoice-card">
                                <div class="card-body d-flex">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-white fs-18">ທີ່ດິນສະຖານະວ່າງ</span>
                                    </div>
                                </div>
                            </div>
                            </a>
                    ...
                    <div class="col-xl-3 col-xxl-3 col-sm-6">
                        <a href="collateral_la_status1.php">
                        <div class="card bg-info invoice-card">
                            <div class="card-body d-flex">
                                ...
                                <div>
                                    ...
                                    <span class="text-white fs-18">ທີ່ດິນສະຖານະທີ່ນຳໃຊ້</span>
                                </div>
                            </div>
                        </div>
                        </a>
                    ...
                    <div class="col-xl-3 col-xxl-3 col-sm-6">
                        <a href="collateral_la_status2.php">
                        <div class="card bg-secondary invoice-card">
                            <div class="card-body d-flex">
                                ...
                                <div>
                                    ...
                                    <span class="text-white fs-18">ທີ່ດີນສະຖານະປິດສັນຍາແລ້ວ</span>
                                </div>
                            </div>
                        </div>
                        </a>
                            ...
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white text-end">
                                        <p class="mb-1 fs-18">ທີ່ດິນທີ່ມີມູນຄ້າການປະເມີນຫຼາຍທີ່ສຸດ</p>
                                        <h3 class="text-white"><?php echo number_format($show_total_expenses) ?> ກີບ</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div style="background: #2980B9;" class="widget-stat card">
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white text-end">
                                        <p class="mb-1 fs-18">ທີ່ດິນທີ່ມີມູນຄ້າການປະເມີນໜ່ອຍທີ່ສຸດ</p>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="collateral_insert_land.php" style="cursor: pointer;" class="btn me-2 btn-primary"><i class="bi bi-person-plus-fill me-2"></i>ບັນທຶກຫຼັກຊັບຄ້ຳປະກັນ</a>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <?php
                                            $stmt = $conn->query("SELECT * FROM collateral_land");
                                            $stmt->execute();
                                            $users = $stmt->fetchAll();
