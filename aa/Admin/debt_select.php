...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>ລາຍງານຂໍ້ມູນໜີ່ສິນ</title>
...
<body>
    ...
    $sql_count_lg_id = mysqli_query($conns, "select count(dt_id) from debt");
    $show_count_lg_id = mysqli_fetch_array($sql_count_lg_id);

    $sql_count_la_status0 = mysqli_query($conns, "select count(dt_id) from debt where dt_status = 1");
    $show_count_la_status0 = mysqli_fetch_array($sql_count_la_status0);

    $sql_count_la_status1 = mysqli_query($conns, "select count(dt_id) from debt where dt_status = 2");
    $show_count_la_status1 = mysqli_fetch_array($sql_count_la_status1);

    $sql_cus_total_expenses = mysqli_query($conns, "select dt_capital_plus_interest from debt where dt_capital_plus_interest = (select max(dt_capital_plus_interest) from debt)");
    ...
    $sql_cus_total_expensesmin = mysqli_query($conns, "select dt_capital_plus_interest from debt where dt_capital_plus_interest = (select min(dt_capital_plus_interest) from debt)");
    ...
    $sql_sum_dt_capital_plus_interest= mysqli_query($conns, "select sum(dt_capital_plus_interest) from debt");
    $show_sum_dt_capital_plus_interest = mysqli_fetch_array($sql_sum_dt_capital_plus_interest);
            ...
            <div class="content-body ">
                <div class="container-fluid">
                    ...
                    <div class="row page-titles">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active"><a href="javascript:void(0)"></a>ລາຍງານຂໍ້ມູນໜີ່ສິນ</li>
                        </ol>
                    </div>
                    <!-- row -->

                    <!-- start box -->
                    <div style="display: flex;" class="card_dap">
                        <div class="row">
                            <div class="col-lg-9">
                                <div class="row">
                                    <div class="col-xl-6 col-xxl-3 col-sm-6">
                                        <div class="card bg-success invoice-card">
                                            <div class="card-body d-flex">
                                                ...
                                                <div>
                                                    <h2 class="text-white invoice-num"><?php echo $show_count_la_status0[0] ?> ຄົນ</h2>
                                                    <span class="text-white fs-18">ຈຳນວນລູກຄ້າຜ່ອນຊຳລະ</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card bg-info invoice-card">
                                            <div class="card-body d-flex">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="text-white fs-18">ຈຳນວນລູກຄ້າທີ່ປິດສັນຍາແລ້ວ</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div style="cursor: pointer;" class="col-xl-4.5 col-xxl-6 col-lg-6 col-sm-6">
                                            ...
                                            <div class="card-body p-4">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body text-white text-end">
                                                        <p class="mb-1 fs-18">ໜີ່ສິນຫຼາຍທີ່ສຸດ</p>
                                        ...
                                        <div style="background: #2980B9;" class="widget-stat card">
                                            <div class="card-body p-4">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body text-white text-end">
                                                        <p class="mb-1 fs-18">ໜີ່ສິນໜ່ອຍທີ່ສຸດ</p>
                            ...
                            <div class="col-lg-3">
                                <div style="height: 290px;" class="card-bx bg-dark-blue">
                                    ...
                                    <div class="card-info text-white">
                                        ...
                                        <h2 class="text-white card-balance"><?php echo number_format($show_sum_dt_capital_plus_interest[0]) ?> ກີບ</h2>
                                        <p class="fs-18">ລວມເປັນເງິນທີ່ຈະຕ້ອງຄືນໃຫ້ກັບສະຖາບັນ</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">ຕາຕະລາງລາຍລະອຽດຂໍ້ມູນໜີ່ສິນ</h4>
                                        ...
                                        <table id="example" class="display" style="min-width: 845px">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>ເງິນຕົ້ນຕໍ່ເດືອນ</th>
                                                    <th>ດອກເບ້ຍຕໍ່ເດືອນ</th>
                                                    <th>ຕົ້ນທຶນ+ດອກເບ້ຍຕໍ່ເດືອນ</th>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo number_format($row['dt_releaseds']); ?> LAK</td>
                                                        <td><?php echo number_format($row['dt_totle_interest']); ?> LAK</td>
                                                        <td><?php echo number_format($row['dt_amount_bepaid_month']); ?> LAK</td>
                                                        <td><?php echo number_format($row['dt_amount_releaseds']); ?> LAK</td>
                                                        <td><?php echo number_format($row['dt_total_interest']); ?> LAK</td>
                                                        <td><?php echo number_format($row['dt_capital_plus_interest']); ?> LAK</td>
                                                        <td>
                                                            <?php
                                                            if ($row['dt_status'] == 1) {
                                                                echo "
