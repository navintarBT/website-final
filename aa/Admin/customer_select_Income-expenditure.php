...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>ລາຍງານຂໍ້ມູນລາຍຮັບ-ລາຍຈ່າຍ</title>
    ...
    <script>
        $(document).ready(function() {
            $('#example3').DataTable({
                "language": {
                    "decimal": "",
                    "emptyTable": "<html><p style='font-size: 18px;'>ບໍ່ຂໍ້ມູນໃນຕາຕະລາງ</p></html>",
                    "info": "<html><p style='font-size: 18px;'>ສະແດງແຖວທີ່ _START_ ຫາ _END_ ຈາກທັງໝົດ _TOTAL_ ແຖວ</p></html>",
                    "infoEmpty": "<html><p style='font-size: 18px;'>ສະແດງແຖວທີ່ 0 ຫາ 0 ຈາກທັງໝົດ 0 ແຖວ</p></html>",
                    "infoFiltered": "<html><p style='font-size: 18px;'>(ບໍ່ມີຂໍ້ມູນທີ່ທ່ານຕ້ອງການຫາ)</p></html>",
                    "infoPostFix": "",
                    "thousands": ",",
                    "lengthMenu": "<html><p style='font-size: 18px;'>ສະແດງ _MENU_ ແຖວ</p></html>",
                    "loadingRecords": "ກຳລັງດາວໂຫລດ...",
                    "processing": "",
                    "search": "ຄົ້ນຫາ:",
                    "zeroRecords": "<html><p style='font-size: 18px;'>ບໍ່ມີຂໍ້ມູນທີ່ທ່ານຕ້ອງການຫາ</p></html>",
                    "paginate": {
                        "first": "ຫນ້າທຳອິດ",
                        "last": "ໜ້າສຸດທ້າຍ",
                        "next": "ທັດໄປ",
...
<body>
    ...
    $sql_cus_total_income = mysqli_query($conns, "select cus_total_income from customers where cus_total_income = (select max(cus_total_income) from customers)");
    $show_cus_total_income = mysqli_fetch_array($sql_cus_total_income);
    if($show_cus_total_income[0] == ""){
        $shohw_total_income = "0";
    }else{
        $shohw_total_income = $show_cus_total_income[0];
    }

    $sql_cus_total_income_min = mysqli_query($conns, "select cus_total_income from customers where cus_total_income = (select min(cus_total_income) from customers)");
    $show_cus_total_income_min = mysqli_fetch_array($sql_cus_total_income_min);
    if($show_cus_total_income_min[0] == ""){
        $shohw_total_income_min = "0";
    }else{
        $shohw_total_income_min = $show_cus_total_income_min[0];
    }

    $sql_cus_total_expenses = mysqli_query($conns, "select cus_total_expenses from customers where cus_total_expenses = (select max(cus_total_expenses) from customers)");
    $show_cus_total_expenses = mysqli_fetch_array($sql_cus_total_expenses);
    if($show_cus_total_expenses[0] == ""){
        $shohw_total_expenses_max = "0";
    }else{
        $shohw_total_expenses_max = $show_cus_total_expenses[0];
    }

    $sql_cus_total_expenses_min = mysqli_query($conns, "select cus_total_expenses from customers where cus_total_expenses = (select min(cus_total_expenses) from customers)");
    $show_cus_total_expenses_min = mysqli_fetch_array($sql_cus_total_expenses_min);
    if($show_cus_total_expenses_min[0] == ""){
        $shohw_total_expenses_min = "0";
    }else{
        $shohw_total_expenses_min = $show_cus_total_expenses_min[0];
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">ລາຍງານຂໍ້ມູນລາຍຮັບ - ລາຍຈ່າຍ</a></li>
                    </ol>
                </div>
                <!-- row -->
                ...
                <div class="row invoice-card-row">
                    <div style="cursor: pointer;" class="col-xl-3 col-xxl-3 col-sm-6">
                        <div class="card bg-warning invoice-card">
                            <div class="card-body d-flex">
                                ...
                                <div>
                                    <h2 class="text-white invoice-num"><?php echo $show_count_cus_id[0] ?> ຄົນ</h2>
                                    <span class="text-white fs-18">ລູກຄ້າທັງໝົດ</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div style="cursor: pointer;" class="col-xl-3 col-xxl-3 col-sm-6">
                        <div class="card bg-success invoice-card">
                            <div class="card-body d-flex">
                                ...
                                <div>
                                    <h2 class="text-white invoice-num"><?php echo $show_count_cus_status0[0] ?> ຄົນ</h2>
                                    <span class="text-white fs-18">ລູກຄ້າໃໝ່</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div style="cursor: pointer;" class="col-xl-3 col-xxl-3 col-sm-6">
                        <div class="card bg-info invoice-card">
                            <div class="card-body d-flex">
                                ...
                                <div>
                                    <h2 class="text-white invoice-num"><?php echo $show_count_cus_status1[0] ?> ຄົນ</h2>
                                    <span class="text-white fs-18">ລູກຄ້າຜ່ອນສຳລະ</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div style="cursor: pointer;" class="col-xl-3 col-xxl-3 col-sm-6">
                        <div class="card bg-secondary invoice-card">
                            <div class="card-body d-flex">
                                ...
                                <div>
                                    <h2 class="text-white invoice-num"><?php echo $show_count_cus_status2[0] ?> ຄົນ</h2>
                                    <span class="text-white fs-18">ລູກຄ້າປິດສັນຍາແລ້ວ</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div style="cursor: pointer;" class="col-xl-6 col-xxl-6 col-lg-6 col-sm-6">
                        <div style="background:#1E8449;" class="widget-stat card">
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white text-end">
                                        <p class="mb-1 fs-18">ລາຍຮັບຫຼາຍທີ່ສຸດ</p>
                                        <h3 class="text-white"><?php echo number_format($shohw_total_income) ?> ກີບ</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div style="cursor: pointer;" class="col-xl-6 col-xxl-6 col-lg-6 col-sm-6">
                        <div style="background: #F39C12;" class="widget-stat card">
                            <div class="card-body p-4">
                                <div class="media">
                                    <span class="me-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-currency-dollar" viewBox="0 0 16 16">
                                    ...
                                    <div class="media-body text-white text-end">
                                        <p class="mb-1 fs-18">ລາຍຮັບໜ່ອຍທີ່ສຸດ</p>
                                        <h3 class="text-white"><?php echo number_format($shohw_total_income_min); ?> ກີບ</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div style="background:#E74C3C;" class="widget-stat card">
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white text-end">
                                        <p class="mb-1 fs-18">ລາຍຈ່າຍຫຼາຍທີ່ສຸດ</p>
                                        <h3 class="text-white"><?php echo number_format($shohw_total_expenses_max) ?> ກີບ</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div style="background: #2980B9;" class="widget-stat card">
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white text-end">
                                        <p class="mb-1 fs-18">ລາຍຈ່າຍໜ່ອຍທີ່ສຸດ</p>
                                        <h3 class="text-white"><?php echo number_format($shohw_total_expenses_min) ?> ກີບ</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mb-3 me-auto">
                        <div class="card-tabs style-1 mt-3 mt-sm-0">
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <a style="font-size: 16px;" class="nav-link active" href="javascript:void(0);" data-bs-toggle="tab" id="transaction-tab" data-bs-target="#AllTransaction" role="tab">ລາຍຮັບ</a>
                                </li>
                                <li class="nav-item">
                                    <a style="font-size: 16px;" class="nav-link" href="javascript:void(0);" data-bs-toggle="tab" id="Completed-tab" data-bs-target="#Completed" role="tab">ລາຍຈ່າຍ</a>
                                </li>
                                <li class="nav-item">
                                    <a style="font-size: 16px;" class="nav-link" href="javascript:void(0);" data-bs-toggle="tab" id="Pending-tab" data-bs-target="#Pending" role="tab">ລາຍຮັບ - ລາຍຈ່າຍ</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <a href="customer_insert.php" class="btn btn-outline-primary mb-3"><i class="fa fa-calendar me-3 scale3"></i>ເພີ້ມລູກຄ້າ</a>
                </div>
                <div class="row">
                    <div class="card">
                            ...
                            <div class="col-xl-12 tab-content">
                                <div class="tab-pane fade show active" id="AllTransaction" role="tabpanel" aria-labelledby="transaction-tab">
                                    <div class="table-responsive fs-14">
                                        <table class="table card-table display mb-4 dataTablesCard text-black" id="example">
                                            <thead>
                                                <tr>
                                                    <th>
                                                    ...
                                                    <th>ເງິນເດືອນ(ຜົວ-ເມຍ)</th>
                                                    <th>ສະມາຊິກຄອບຄົວ</th>
                                                    <th>ການຄ້າຂາຍ</th>
                                                    <th>ການໃຫ້ເຊົ່າ</th>
                                                    <th>ລາຍຮັບພິເສດອື່ນໆ</th>
                                                    <th>ລວມລາຍຮັບ</th>
                                                    <th>ຄິດເປັນເປີເຊັນ</th>
                                                    <th>ເມນູ</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo number_format($row['cus_income_salary']); ?> LAK</td>
                                                        <td><?php echo number_format($row['cus_income_famiry']); ?> LAK</td>
                                                        <td><?php echo number_format($row['cus_income_trading']); ?> LAK</td>
                                                        <td><?php echo number_format($row['cus_income_rental']); ?> LAK</td>
                                                        <td><?php echo number_format($row['cus_special_income']); ?> LAK</td>
                                                        <td><?php echo number_format($row['cus_total_income']); ?> LAK</td>
                                                        <td class="text-success"> <span class="me-2 oi-icon bgl-success">
                                                            ...
                                                            </span><?php echo $row['percentage_income']; ?> % </td>
                                                        <td>
                                                            <div class="btn-group dropstart">
                                                                ...
                                                                <div style="background: #FDFEFE;" class="dropdown-menu">
                                                                    ...
                                                                    <hr>
                                                                    <a class="dropdown-item button_edit" href="customer_update_Income-expenditure.php?id=<?php echo $row['cus_id']; ?> ">ແກ້ໄຂຂໍ້ມູນ</a>
                                ...
                                <div class="tab-pane fade" id="Completed" role="tabpanel" aria-labelledby="Completed-tab">
                                    <div class="table-responsive fs-14">
                                        <table class="table card-table display mb-4 dataTablesCard text-black" id="example3">
                                            <thead>
                                                <tr>
                                                    <th>
                                                        <div class="form-check custom-checkbox">
                                                    ...
                                                    <th style="width: 90px;">#ລະຫັດ</th>
                                                    <th>ຊື່ ແລະ ນາມສະກຸນ</th>
                                                    <th>ລົງທຶນຄ້າຂາຍ</th>
                                                    <th>ຄ່າເຊົ່າເຮືອນ</th>
                                                    <th style="width: 90px;">ຄົວເຮືອນ</th>
                                                    <th>ໜີ່ສິນອື່ນໆ</th>
                                                    <th style="width: 90px;">ອື່ນໆ</th>
                                                    <th>ລວມລາຍຈ່າຍ</th>
                                                    <th>ຄິດເປັນເປີເຊັນ</th>
                                                    <th>ເມນູ</th>
                                                </tr>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['cus_runing']; ?></td>
                                                        <td><?php echo $row['cus_fname']; ?></td>
                                                        <td><?php echo number_format($row['cus_expenditure_invest']); ?> LAK</td>
                                                        <td><?php echo number_format($row['cus_expenditure_house_rent']); ?>LAK</td>
                                                        <td><?php echo number_format($row['cus_expenditure_normal']); ?> LAK</td>
                                                        <td><?php echo number_format($row['cus_expenditure_debt']); ?> LAK</td>
                                                        <td><?php echo number_format($row['cus_expenditure_other']); ?> LAK</td>
                                                        <td><?php echo number_format($row['cus_total_expenses']); ?> LAK</td>
                                                        <td class="text-danger"> <span class="me-2 oi-icon bgl-danger">
                                                            ...
                                                            </span><?php echo $row['percentage_expenses']; ?> %</td>
                                                        <td>
                                                            <div class="btn-group dropstart">
                                                                <div class="btn-link" data-bs-toggle="dropdown">
                                                                    <svg width="24px" height="24px" viewbox="0 0 24 24" version="1.1">
                                ...
                                <div class="tab-pane fade" id="Pending" role="tabpanel" aria-labelledby="Pending-tab">
                                    <div class="table-responsive fs-14">
                                        <table class="table card-table display mb-4 dataTablesCard text-black" id="example2">
                                            <thead>
                                                <tr>
                                                    <th>
                                                        ລາຍງານຂໍ້ມູນລາຍຮັບ - ລາຍຈ່າຍ
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                        ...
                                                        <td>
                                                            <div class="col-xl-12">
                                                                <div style="
                                                                        ...
                                                                        text-align: center;" class="card">
                                                                    <div class="card-body pb-3">
                                                                        <div class="row align-items-center">
                                                                            <div class="col-xl-3">
                                                                                <h4 class="mb-2">ລະຫັດລູ້ຄ້າ</h4>
                                                                                <h3 class="mb-0"><?php echo $row['cus_runing']; ?></h2>
                                                                            </div>
                                                                            <div class="col-xl-3">
                                                                                <p class="mb-2">ຊື່ ແລະ ນາມສະກຸນ</p>
                                                                                <h3 class="mb-0"><?php echo $row['cus_fname']; ?></h2>
                                                                            </div>
                                                                            <div class="col-xl-3">
                                                                                <p class="mb-0">ຈຳນວນເງິນທີ່ຍັງເຫຼືອ</p>
                                                                                <h3 style="color: #8E44AD;" class="mb-0"><?php echo number_format($row['cus_amount_income']); ?> LAK</h2>
                                                                            </div>
                                                                            <div class="col-xl-3 d-flex flex-wrap justify-content-end align-items-center">
                                                                    ...
                                                                    <div class="card-body transaction-details d-flex flex-wrap justify-content-between align-items-center">
                                                                        <div class="me-1 mb-1">
                                                                            <h4 class="mb-2">ເງິນເດືອນປະຈຳ (ຜົວ-ເມຍ)</h4>
                                                                            <h4 style="color: #2ECC71;" class="mb-0"><?php echo number_format($row['cus_income_salary']); ?> LAK</h4>
                                                                        </div>
                                                                        <div class="me-1 mb-1">
                                                                            <h4 class="mb-2">ລາຍຮັບຈາກສະມາຊິກຄອບຄົວ</h4>
                                                                            <h4 style="color: #2ECC71;" class="mb-0"><?php echo number_format($row['cus_income_famiry']); ?> LAK</h4>
                                                                        </div>
                                                                        <div class="me-1 mb-1">
                                                                            <h4 class="mb-2">ລາຍຮັບຈາກການຄ້າຂາຍ</h4>
                                                                            <h4 style="color: #2ECC71;" class="mb-0"><?php echo number_format($row['cus_income_trading']); ?> LAK</h4>
                                                                        </div>
                                                                        <div class="me-1 mb-1">
                                                                            <h4 class="mb-2">ລາຍຮັບຈາກການໃຫ້ເຊົ່າ</h4>
                                                                            <h4 style="color: #2ECC71;" class="mb-0"><?php echo number_format($row['cus_income_rental']); ?> LAK</h4>
                                                                        </div>
                                                                        <div class="me-1 mb-1">
                                                                            <h4 class="mb-2">ລາຍຮັບພິເສດອື່ນໆ</h4>
                                                                            <h4 style="color: #2ECC71;" class="mb-0"><?php echo number_format($row['cus_special_income']); ?> LAK</h4>
                                                                        </div>
                                                                        <div class="me-1 mb-1">
                                                                            <h4 class="mb-2">ລວມລາຍຮັບ</h4>
                                                                            <h4 style="color: #2ECC71;" class="mb-0"><?php echo number_format($row['cus_total_income']); ?> LAK</h4>
                                                                        </div>
                                                                        <div class="me-1 mb-1">
                                                                            <h4 class="mb-2">ເປີເຊັນລາຍຮັບ</h4>
                                                                            <h4 style="color: #2ECC71;" class="mb-0"><?php echo $row['percentage_income']; ?> %</h4>
                                                                        </div>
                                                                        <div style="background: #D5F5E3;" class="amount-bx mb-1">
                                                                            <i class="fas fa-dollar-sign bg-success"></i>
                                                                            <div>
                                                                                <p class="mb-1">ລວມລາຍຮັບ</p>
                                                                                <h3 class="mb-0"><?php echo number_format($row['cus_total_income']); ?> LAK</h3>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="card-body transaction-details d-flex flex-wrap justify-content-between align-items-center">
                                                                        <div class="me-1 mb-1">
                                                                            <h4 class="mb-2">ລາຍຈ່າຍໃນການລົງທຶນຄ້າຂາຍ</h4>
                                                                            <h4 style="color: #E74C3C;" class="mb-0"><?php echo number_format($row['cus_expenditure_invest']); ?> LAK</h4>
                                                                        </div>
                                                                        <div class="me-1 mb-1">
                                                                            <h4 class="mb-2">ລາຍຈ່າຍຄ່າເຊົ່າເຮືອນ</h4>
                                                                            <h4 style="color: #E74C3C;" class="mb-0"><?php echo number_format($row['cus_expenditure_house_rent']); ?> LAK</h4>
                                                                        </div>
                                                                        <div class="me-1 mb-1">
                                                                            <h4 class="mb-2">ລາຍຈ່າຍປົກກະຕິໃນຄົວເຮືອນ</h4>
                                                                            <h4 style="color: #E74C3C;" class="mb-0"><?php echo number_format($row['cus_expenditure_normal']); ?> LAK</h4>
                                                                        </div>
                                                                        <div class="me-1 mb-1">
                                                                            <h4 class="mb-2">ລາຍຈ່າຍໜີ່ສິນອື່ນໆ</h4>
                                                                            <h4 style="color: #E74C3C;" class="mb-0"><?php echo number_format($row['cus_expenditure_debt']); ?> LAK</h4>
                                                                        </div>
                                                                        <div class="me-1 mb-1">
                                                                            <h4 class="mb-2">ລາຍຈ່າຍໜີ່ສິນອື່ນໆ</h4>
                                                                            <h4 style="color: #E74C3C;" class="mb-0"><?php echo number_format($row['cus_expenditure_debt']); ?> LAK</h4>
                                                                        ...
                                                                        <div class="me-1 mb-1">
                                                                            <h4 class="mb-2">ລາຍຈ່າຍອື່ນໆ</h4>
                                                                            <h4 style="color: #E74C3C;" class="mb-0"><?php echo number_format($row['cus_expenditure_other']); ?> LAK</h4>
                                                                        </div>
                                                                        <div class="me-1 mb-1">
                                                                            <h4 class="mb-2">ເປີເຊັນລາຍຈ່າຍ</h4>
                                                                            <h4 style="color: #E74C3C;" class="mb-0"><?php echo $row['percentage_expenses']; ?> %</h4>
                                                                        </div>
                                                                        <div style="background: #F5B7B1;" class="amount-bx mb-1">
                                                                            <i class="fas fa-dollar-sign bg-danger"></i>
                                                                            <div>
                                                                                <p class="mb-1">ລວມລາຍຈ່າຍ</p>
                                                                                <h3 class="mb-0"><?php echo number_format($row['cus_total_expenses']); ?> LAK</h3>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
            ...
            Swal.fire({
                ...
                preConfirm: function() {
                    return new Promise(function(resolve) {
                        $.ajax({
                                url: 'customer_select_Income-expenditure.php',
                                type: 'GET',
                                data: 'delete=' + userId,
                            })
                            .done(function() {
