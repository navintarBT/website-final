...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>ລາຍງານຂໍ້ມູນຫຼັບຊັບຄ້ຳປະກັນ ທີ່ດິນ ທີ່ມີສະຖານະວ່າງ</title>
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            <div class="dashboard_bar">
                                ລາຍງານຂໍ້ມູນຫຼັບຊັບຄ້ຳປະກັນ ທີ່ດິນ ທີ່ມີສະຖານະວ່າງ
                            </div>
                        </div>
        ...
        <div class="content-body ">
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a href="javascript:void(0)"></a>ລາຍງານຂໍ້ມູນຫຼັບຊັບຄ້ຳປະກັນ ທີ່ດິນ ທີ່ມີສະຖານະວ່າງ</li>
                    </ol>
                </div>
                <!-- row -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">ລາຍງານຂໍ້ມູນຫຼັບຊັບຄ້ຳປະກັນ ທີ່ດິນ ທີ່ມີສະຖານະວ່າງ</h4>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <?php
                                            $stmt = $conn->query("select * from collateral_land where la_status = 0");
                                            $stmt->execute();
                                            $users = $stmt->fetchAll();
