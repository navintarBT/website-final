...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>ລາຍງານຂໍ້ມູນການສະເໜີຂໍກູ້ຢຶມເງິນ</title>
...
<body>
    ...
    $sql_cus_qty_money = mysqli_query($conns, "select cus_qty_money from customers where cus_qty_money = (select max(cus_qty_money) from customers)");
    $show_cus_qty_money = mysqli_fetch_array($sql_cus_qty_money);
    if($show_cus_qty_money == ""){
        $shohw_total_expenses_max = "0";
    }else{
        $shohw_total_expenses_max = $show_cus_qty_money;
    }
    

    $sql_cus_qty_moneymin = mysqli_query($conns, "select cus_qty_money from customers where cus_qty_money = (select min(cus_qty_money) from customers)");
    $show_cus_qty_moneymin = mysqli_fetch_array($sql_cus_qty_moneymin);
    if($show_cus_qty_moneymin == ""){
        $shohw_total_expenses_min = "0";
    }else{
        $shohw_total_expenses_min = $show_cus_qty_moneymin;
    }
                                ...
                                <div class="card-body p-4">
                                    <div class="media">
                                        ...
                                        <div class="media-body text-white text-end">
                                            <p class="mb-1 fs-18">ຈຳນວນເງິນທີ່ສະເໜີກູ້ຢຶມຫຼາຍທີ່ສຸດ</p>
                                            <h3 class="text-white"><?php echo number_format($shohw_total_expenses_max[0]); ?> ກີບ</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="widget-stat card bg-primary">
                                <div class="card-body p-4">
                                    <div class="media">
                                        ...
                                        <div class="media-body text-white text-end">
                                            <p class="mb-1 fs-18">ຈຳນວນເງິນກູ້ຢຶມໜ່ອຍທີ່ສຸດ</p>
                                            <h3 class="text-white"><?php echo number_format($shohw_total_expenses_min[0]) ?> ກີບ</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <table id="example" class="display" style="min-width: 845px">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>ຈຸດປະສົງ</th>
                                                    <th>ຈຳນວນເງິນທີ່ຕ້ອງການກູ້</th>
                                                    <th>ກຳນົດເວລາທີຕ້ອງການ</th>
                                                    <th>ຊັບສົມບັດຄ້ຳປະກັນ</th>
                                                    <th>ແຫຼ່ງລາຍຮັບປະຈຳ</th>
                                                    <th>ສະຖານະ</th>
                                                    <th>ເມນູ</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['cus_purpose_money']; ?></td>
                                                        <td><?php echo number_format($row['cus_qty_money']); ?> LAK</td>
                                                        <td><?php echo $row['cus_date_of_loan']; ?> ເດືອນ</td>
                                                        <td><?php echo $row['cus_collateral_assets']; ?></td>
                                                        <td><?php echo $row['cus_regular_money']; ?></td>
                                                        ...
                                                        <td>
                                                            <div class="btn-group dropstart mb-1">
                                                                ...
                                                                <div style="background: #FDFEFE;" class="dropdown-menu">
                                                                    ...
                                                                    <hr>
                                                                    <a class="dropdown-item button_edit" href="customer_update_offer.php?id=<?php echo $row['cus_id']; ?> ">ແກ້ໄຂຂໍ້ມູນ</a>
