...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>ລາຍງານຈຳນວນການເຮັດສັນຍາພາຍໃນມື້ນີ້</title>
                        ...
                        <div class="collapse navbar-collapse justify-content-between">
                            <div class="header-left">
                                <div class="dashboard_bar">
                                    ລາຍງານຂໍ້ມູນຈຳນວນການເຮັດສັນຍາພາຍໃນມື້ນີ້
                                </div>
                            </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:void(0)">ລາຍງານຂໍ້ມູນຈຳນວນການເຮັດສັນຍາພາຍໃນມື້ນີ້</a></li>
                        </ol>
                    </div>
                    <!-- row -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">ຕາຕະລາງລາຍລະອຽດຂໍ້ມູນການເຮັດສັນຍາພາຍໃນມື້ນີ້</h4>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example" class="display" style="min-width: 845px">
                                            ...
                                            <tbody>
                                                <?php
                                                $stmt = $conn->query("select * from loan_agreement where lg_date_in = curdate()");
                                                $stmt->execute();
                                                $users = $stmt->fetchAll();
