...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>ລາຍງານຂໍ້ມູນການຕິດຕໍ່ພົວພັນ</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:void(0)">ລາຍງານຂໍ້ມູນການຕິດຕໍ່ພົວພັນ</a></li>
                        </ol>
                    </div>
                    <!-- row -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">ຕາຕະລາງລາຍລະອຽດຂໍ້ມູນການຕິດຕໍ່ພົວພັນ</h4>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['cus_tel_phone']; ?></td>
                                                        ...
                                                        <td>
                                                            <div class="btn-group dropstart mb-1">
                                                                ...
                                                                <div style="background: #FDFEFE;" class="dropdown-menu">
                                                                    ...
                                                                    <hr>
                                                                    <a class="dropdown-item button_edit" href="customer_update_contact.php?id=<?php echo $row['cus_id']; ?> ">ແກ້ໄຂຂໍ້ມູນ</a>
                ...
                Swal.fire({
                    ...
                    preConfirm: function() {
                        return new Promise(function(resolve) {
                            $.ajax({
                                    url: 'customer_select_contact.php',
                                    type: 'GET',
                                    data: 'delete=' + userId,
                                })
                                .done(function() {
                                    Swal.fire({
                                        ...
                                        document.location.href = 'customer_select_contact.php';
                                    })
                                })
                                .fail(function() {
