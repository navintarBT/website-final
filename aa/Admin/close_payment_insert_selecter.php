...
<head>
    ...
    $lastid = $row[0];
    // Assuming $lastid is the last generated ID
    $lastid = ''; // Replace this with your actual last ID
    
    if (empty($lastid)) {
        // If no last ID, create a new one with a default value
        $numbers = "S&K/00001/" . date("Y");
    } else {
        // Extract the numeric part of the last ID, increment it, and format it
        $idd = (int) str_replace("S&K/", "", $lastid);
        $id = str_pad($idd + 1, 5, '0', STR_PAD_LEFT);
        $numbers = 'S&K/' . $id . '/' . date("Y");
    }
                    ...
                    <ul class="metismenu" id="menu">
                            ...
                            <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown">
                                ...
                                <div class="header-info ms-3">
                                    <span class="font-w600 "><b>
                                            <?php echo $_SESSION['user_flname']; ?>
                                        </b></span>
                                    <small class="font-w400">
                                        <?php echo $_SESSION['user_satus']; ?>
                                    </small>
                                </div>
                            </a>
                            <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                ...
                                <li><a style="font-size: 18px;" href="customer_select_offer.php">ຂໍ້ມູນສະເໜີຂອງລູກຄ້າ</a>
                                </li>
                                <li><a style="font-size: 18px;"
                                        href="customer_select_Identification_card.php">ຂໍ້ມູນບັດປະຈຳຕົວ</a></li>
                                ...
                                <li><a style="font-size: 18px;" href="customer_select_Income-expenditure.php">ຂໍ້ມູນ ລາຍຮັບ
                                        - ລາຈ່າຍ</a>
                            </ul>
                        </li>
                        <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                <li><a style="font-size: 18px;" href="collateral_insert_land.php">ບັນທຶກຫຼັກຊັບຄຳປະກັນ</a>
                                </li>
                                <li><a style="font-size: 18px;"
                                        href="collateral_select_land.php">ລາຍງານທີ່ດິນ-ສິ່ງປູກສ້າງ</a></li>
                                <li><a style="font-size: 18px;" href="collateral_select_car.php">ລາຍງານລົດໃຫຍ່-ລົດຈັກ</a>
                                </li>
                                <li><a style="font-size: 18px;" href="collateral_select_other.php">ລາຍງານຫຼັກຊັບອື່ນໆ</a>
                                </li>
                            </ul>
                        </li>
                        <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                <li><a style="font-size: 18px;"
                                        href="credit_analysis_insert.php">ບັນທຶກການວິເຄາະສິນເສື່ອ</a></li>
                                <li><a style="font-size: 18px;" href="credit_analysis_select.php">ລາຍການວິເຄາະສິນເຊື່ອ</a>
                                </li>
                            </ul>
                        </li>
                        <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                <li><a style="font-size: 18px;" href="credit_release_insert.php">ບັນທຶກການປ່ອຍສິນເຊື່ອ</a>
                                </li>
                                <li><a style="font-size: 18px;" href="credit_release_select.php">ລາຍງານການປ່ອຍສິນເສື່ອ</a>
                                </li>
                            </ul>
                        </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="" id="close_payment_insert" class="needs-validation" novalidate=""
                                    ...
                                    if (isset($_GET['id'])) {
                                        ...
                                        $result = mysqli_query($conns, $query);
                                        $row = mysqli_fetch_array($result);
                                        $row = ""; // Replace this with your actual last ID
                                
                                        if ($row == "") {
                                            // If no last ID, create a new one with a default value
                                            $number = "S&K/01/" . date("Y");
                                        } else {
                                            // Extract the numeric part of the last ID, increment it, and format it
                                            $lastid = $row;
                                            $idd = (int) str_replace("S&K/", "", $lastid);
                                            $id = str_pad($idd + 1, 2, '0', STR_PAD_LEFT);
                                            $number = 'S&K/' . $id . '/' . date("Y");
                                        }
                                    }
                                    ...
                                    <div class=" row">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-12">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control cp_id"
                                                            id="validationCustom01" value="<?php echo $numbers; ?>"
                                                            required="" name="cp_id" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <div style="margin-top: 1rem;" class="mb-1 row">
                                                <div class="col-xl-12">
                                                    <label class="col-form-label"
                                                        for="validationCustom06">ເລກທີ່ສັນຍາເງິນກູ້
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="input-group">
                                                        <span style="cursor: pointer;" class="input-group-text"
                                                            data-bs-toggle="modal" data-bs-target="#exampleModal"
                                                            id="inputGroupPrepend"><svg xmlns="http://www.w3.org/2000/svg"
                                                                width="20" height="20" fill="currentColor"
                                                                class="bi bi-search" viewBox="0 0 16 16">
                                                                <path
                                                                    d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
                                                            </svg></span>
                                                        <input type="text" class="form-control lg_runing_id"
                                                            id="validationCustom01" value="<?= $loan['lg_runing_id']; ?>"
                                                            placeholder="ປ້ອນເລກທີ່ສັນຍາເງິນກູ້..." required=""
                                                            name="lg_runing_id">
                                                    </div>
                                                    <input type="hidden" class="form-control cp_lg_date"
                                                        value="<?= $loan['lg_date_in']; ?>" id="validationCustom01"
                                                        placeholder="ລະຫັດສັນຍາ" required="" name="cp_lg_date">
                                                    <input type="hidden" class="form-control cp_amount_releaseds"
                                                        value="<?= $loan['lg_amount_releaseds']; ?>" id="validationCustom01"
                                                        placeholder="ລະຫັດສັນຍາ" required="" name="cp_amount_releaseds">
                                                    <input type="hidden" class="form-control cp_interest"
                                                        value="<?= $loan['lg_interest']; ?>" id="validationCustom01"
                                                        placeholder="ລະຫັດສັນຍາ" required="" name="cp_interest">
                                                    <input type="hidden" class="form-control cp_set_month"
                                                        value="<?= $loan['lg_set_month']; ?>" id="validationCustom01"
                                                        placeholder="ລະຫັດສັນຍາ" required="" name="cp_set_month">
                                                    <input type="hidden" class="form-control cp_total_interest"
                                                        value="<?= $loan['lg_total_interest']; ?>" id="validationCustom01"
                                                        placeholder="ລະຫັດສັນຍາ" required="" name="cp_total_interest">
                                                    <input type="hidden" class="form-control cp_capital_plus_interest"
                                                        value="<?= $loan['lg_capital_plus_interest']; ?>"
                                                        id="validationCustom01" placeholder="ລະຫັດສັນຍາ" required=""
                                                        name="cp_capital_plus_interest">
                                                    <input type="hidden" class="form-control sum_pm_pcp_itr"
                                                        value="<?= $sum_pm_pcp_itr[0]; ?>" id="validationCustom01"
                                                        placeholder="ລະຫັດລູ້ຄ້າruning" required="" name="sum_pm_pcp_itr">
                                                    <input type="hidden" class="form-control lg_id"
                                                        value="<?= $loan['lg_id']; ?>" id="validationCustom01"
                                                        placeholder="ລະຫັດສັນຍາ" required="" name="lg_id">
                                                    <input type="hidden" class="form-control cus_id"
                                                        value="<?= $data['cus_id']; ?>" id="validationCustom01"
                                                        placeholder="ໄອດີລູກຄ້າ" required="" name="cus_id">
                                                    <input type="hidden" class="form-control cus_runing"
                                                        value="<?= $data['cus_runing']; ?>" id="validationCustom01"
                                                        placeholder="ໄອດີລູກຄ້າ" required="" name="cus_runing">
                                                    <input type="hidden" class="form-control cus_fname"
                                                        value="<?= $data['cus_fname']; ?>" id="validationCustom01"
                                                        placeholder="ລະຫັດລູ້ຄ້າruning" required="" name="cus_fname"
                                                        readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-10">
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div
                                                    class="col-xl-6 d-flex flex-wrap justify-content-between align-items-center">
                                            ...
                                            <div
                                                ...
                                                <div class="me-3 mb-3">
                                                    ...
                                                    <h4 class="mb-0">
                                                        <?= number_format($loan['lg_amount_releaseds']); ?> ກີບ
                                                    </h4>
                                                </div>
                                                <div class="me-3 mb-3">
                                                    <p class="mb-2 fs-16">ອັດຕາດອກເບ້ຍ</p>
                                                    <h4 class="mb-0">
                                                        <?= number_format($loan['lg_interest']); ?> %
                                                    </h4>
                                                </div>
                                                <div class="me-3 mb-3">
                                                    <p class="mb-2 fs-16">ກຳນົດໄລຍະເວລາ</p>
                                                    <h4 class="mb-0">
                                                        <?= number_format($loan['lg_set_month']); ?> ເດືອນ
                                                    </h4>
                                                </div>
                                                <div class="me-3 mb-3">
                                                    <p class="mb-2 fs-16">ດອກເບ້ຍ</p>
                                                    <h4 class="mb-0">
                                                        <?= number_format($loan['lg_total_interest']); ?> ກີບ
                                                    </h4>
                                                </div>
                                                <div class="amount-bx mb-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <h3 class="mb-0">
                                                            <?= number_format($loan['lg_capital_plus_interest']); ?> ກີບ
                                                        </h3>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card">
                                                <div class="card-header border-0 pb-0">
                                                    <div>
                                                        <h4 class="card-title mb-2">
                                                            ລາຍງານຂໍ້ມູນຫຍໍ່ການຊຳລະໜີ່ສິນທັງໝົດຂອງລູກຄ້າ</h4>
                                                        <!-- <span class="fs-12">Lorem ipsum dolor sit amet, consectetur</span> -->
                                                    </div>
                                                </div>
                                                <div class="card-body pt-3">
                                                    <p class="description">
                                                        ທີ່ຜ່ານມາລູກຄ້າໄດ້ມີການຊຳລະໜີ່ສິນທັງໝົດດັ່ງລຸ່ມນີ້:</p>
                                                    <ul class="specifics-list">
                                                        <li>
                                                            <span style="height: 65px;" class="bg-blue"></span>
                                                            <div>
                                                                <h4 class="fs-24">
                                                                    <?= number_format($sum_pm_pcp[0]); ?> ກີບ
                                                                </h4>
                                                        ...
                                                        <li>
                                                            ...
                                                            <div>
                                                                <h4 class="fs-24">
                                                                    <?= number_format($sum_pm_itr[0]); ?> ກີບ
                                                                </h4>
                                                        ...
                                                        <li>
                                                            ...
                                                            <div>
                                                                <h4 class="fs-24">
                                                                    <?= number_format($sum_pm_pcp_itr[0]); ?> ກີບ
                                                                </h4>
                                                        ...
                                                        <li>
                                                            ...
                                                            <div>
                                                                <h4 class="fs-24">
                                                                    <?= number_format($sum_pm_fines[0]); ?> ກີບ
                                                                </h4>
                                                ...
                                                <div class="progress default-progress">
                                                    <div class="progress-bar bg-gradient-5 progress-animated"
                                                        style="width:<?php echo $totle_multiply; ?>%; height:20px;"
                                                        role="progressbar">
                                                        <span class="fs-16"> ຊຳລະແລ້ວ
                                                            <?php echo number_format($totle_multiply); ?> %
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="card-footer d-flex flex-row-reverse bd-highlight">
                                            <button type="submit" id="submit" name="submit"
                                                class="btn me-2 btn-primary submit">ບັນທຶກຂໍ້ມູນ</button>
