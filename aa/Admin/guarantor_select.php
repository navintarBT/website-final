...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>ລາຍງານຂໍ້ມູນຜູ້ຄຳປະກັນ</title>
...
<body>
        ...
        $sql_count_lg_id = mysqli_query($conns, "select count(gt_id) from guarantor");
        $show_count_lg_id = mysqli_fetch_array($sql_count_lg_id);

        $sql_count_la_status0 = mysqli_query($conns, "select count(gt_id) from guarantor where gt_satatus = 0");
        $show_count_la_status0 = mysqli_fetch_array($sql_count_la_status0);

        $sql_count_la_status1 = mysqli_query($conns, "select count(gt_id) from guarantor where gt_satatus = 1");
        $show_count_la_status1 = mysqli_fetch_array($sql_count_la_status1);

        $sql_count_la_status2 = mysqli_query($conns, "select count(gt_id) from guarantor where gt_satatus = 2");
            ...
            <div class="content-body ">
                <div class="container-fluid">
                    ...
                    <div class="row page-titles">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active"><a href="javascript:void(0)"></a>ຜູ້ຄຳປະກັນ</li>
                            <li class="breadcrumb-item"><a href="javascript:void(0)">ລາຍງານຂໍ້ມູນລາຍງານຂໍ້ມູນຜູ້ຄຳປະກັນ</a></li>
                        </ol>
                    </div>
                    <!-- row -->
                        ...
                        <div class="col-xl-3 col-xxl-3 col-sm-6">
                            <div class="card bg-warning invoice-card">
                                <div class="card-body d-flex">
                                    ...
                                    <div>
                                        <h2 class="text-white invoice-num"><?php echo $show_count_lg_id[0] ?> ຄົນ</h2>
                                        <span class="text-white fs-18">ຜູ້ຄ້ຳປະກັນທັງໝົດ</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card bg-success invoice-card">
                                <div class="card-body d-flex">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-white fs-18">ຜູ້ຄ້ຳປະກັນທີ່ວ່າງ</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card bg-info invoice-card">
                                <div class="card-body d-flex">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-white fs-18">ຜູ້ຄ້ຳປະກັນທີ່ນຳໃຊ້</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-xxl-3 col-sm-6">
                            <div class="card bg-secondary invoice-card">
                                <div class="card-body d-flex">
                                    ...
                                    <div>
                                        <h2 class="text-white invoice-num"><?php echo $show_count_la_status2[0] ?> ຄົນ</h2>
                                        <span class="text-white fs-18">ຜູ້ຄ້ຳປະກັນທີ່ປິດສັນຍາແລ້ວ</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">ຕາຕະລາງລາຍລະອຽດຂໍ້ມູນຜູ້ຄຳປະກັນ</h4>
                                    <a href="guarantor_insert.php" class="btn me-2 btn-primary submit"><i class="bi bi-person-plus-fill me-2"></i>ບັນທຶກຜູ້ຄ້ຳປະກັນ</a>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example" class="display" style="min-width: 845px">
                                            ...
                                            <tbody>
                                                <?php
                                                $stmt = $conn->query("SELECT * FROM guarantor");
                                                $stmt->execute();
                                                $users = $stmt->fetchAll();
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['gt_runing_id']; ?></td>
                                                        <td><?php echo $row['gt_flname']; ?></td>
                                                        <td><?php echo $row['gt_date_card']; ?></td>
                                                        <td><?php echo $row['gt_age']; ?> ປີ</td>
                                                        <td><?php echo $row['gt_nationality']; ?> </td>
                                                        <td><?php echo $row['gt_job']; ?></td>
                                                        <td><?php echo $row['gt_vill']; ?></td>
                                                        <td><?php echo $row['gt_dis']; ?></td>
                                                        <td><?php echo $row['gt_pro']; ?></td>
