...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>ລາຍງານຂໍ້ມູນໜັງສືເດີນທາງ</title>
...
<body>
    ...
    <?php
    require_once "config/conect_nal.php";
    $sql_count_cus_id = mysqli_query($conns, "select count(cus_id) from customers where cus_passprot_number <> 0");
    $show_count_cus_id = mysqli_fetch_array($sql_count_cus_id);

    $sql_count_cus_passprot_expiry_date = mysqli_query($conns, "select count(cus_id) from customers where cus_passprot_expiry_date < curdate() and cus_passprot_expiry_date <> 0000-00-00");
    $show_count_cus_passprot_expiry_date = mysqli_fetch_array($sql_count_cus_passprot_expiry_date);
    ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:void(0)">ລາຍງານຂໍ້ມູນໜັງສືເດີນທາງ</a></li>
                        </ol>
                    </div>
                    <!-- row -->
                    ...
                    <div class="row invoice-card-row">
                        <div style="cursor: pointer;" class="col-xl-6 col-xxl-3 col-sm-6">
                            <div style="background: #34495E;" class="card invoice-card">
                                <div class="card-body d-flex">
                                    ...
                                    <div>
                                        <span class="text-white fs-18">ຈຳນວນໜັງສືເດີນທາງ</span>
                                ...
                                <div class="card-body p-4">
                                    <div class="media">
                                        ...
                                        <div class="media-body text-white text-end">
                                            <p class="mb-1 fs-18">ຈຳນວນໜັງສືເດີນທາງໝົດອາຍຸ</p>
                                            <h3 class="text-white"><?php echo $show_count_cus_passprot_expiry_date[0] ?> ຄົນ</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example" class="display" style="min-width: 845px">
                                            ...
                                            <tbody>
                                                <?php
                                                $sql = mysqli_query($conns, "SELECT * FROM customers where cus_familybook_id <> 0");
                                                $a = 1;
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php
                                                            if ($row['cus_passprot_number'] == "") {
                                                                echo "ບໍ່ມີຂໍ້ມູນ!";
                                                            } else {
                                                                echo $row['cus_passprot_number'];
                                                            }
                                                            ?></td>
                                                        <td><?php
                                                            if ($row['cus_passprot_expiry_date'] == "0000-00-00") {
                                                                echo "ບໍ່ມີຂໍ້ມູນ!";
                                                            } else {
                                                                echo $row['cus_passprot_expiry_date'];
                                                            }
                                                            ?></td>
                                                        ...
                                                        <td>
                                                            <div class="btn-group dropstart mb-1">
                                                                ...
                                                                <div style="background: #FDFEFE;" class="dropdown-menu">
                                                                    ...
                                                                    <hr>
                                                                    <a class="dropdown-item button_edit" href="customer_update_passport.php?id=<?php echo $row['cus_id']; ?> ">ແກ້ໄຂຂໍ້ມູນ</a>
                ...
                Swal.fire({
                    ...
                    preConfirm: function() {
                        return new Promise(function(resolve) {
                            $.ajax({
                                    url: 'customer_selelct_passport.php',
                                    type: 'GET',
                                    data: 'delete=' + userId,
                                })
                                .done(function() {
                                    Swal.fire({
                                        ...
                                        document.location.href = 'customer_selelct_passport.php';
                                    })
                                })
                                .fail(function() {
