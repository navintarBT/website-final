...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>ລາຍງານຂໍ້ມູນລູກຄ້າບໍ່ມີສັນຍາທັງໝົດ</title>
                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            ...
                            ລາຍງານຂໍ້ມູນລູກຄ້າບໍ່ມີສັນຍາທັງໝົດ
                            </div>
                        </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">ລາຍງານຂໍ້ມູນລູກຄ້າບໍ່ມີສັນຍາທັງໝົດ</a></li>
                    </ol>
                </div>
                <!-- row -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">ລາຍງານຂໍ້ມູນລູກຄ້າບໍ່ມີສັນຍາ</h4>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = mysqli_query($conns, "select * from customers where cus_status = 0");
                                            $a = 1;
