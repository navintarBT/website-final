...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>ລາຍງານຂໍ້ມູນຫຼັບຊັບຄ້ຳປະກັນ ລົດຈັກ-ລົດໃຫຍ່ ທີ່ມີສະຖານະນຳໃຊ້</title>
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            <div class="dashboard_bar">
                                ຫຼັບຊັບຄ້ຳປະກັນ ລົດຈັກ-ລົດໃຫຍ່ ທີ່ມີສະຖານະນຳໃຊ້
                            </div>
                        </div>
        ...
        <div class="content-body ">
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a href="javascript:void(0)"></a>ລາຍງານຂໍ້ມູນຫຼັບຊັບຄ້ຳປະກັນ ລົດຈັກ-ລົດໃຫຍ່ ທີ່ມີສະຖານະນຳໃຊ້</li>
                    </ol>
                </div>
                <!-- row -->
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <?php
                                            $stmt = $conn->query("select * from collateral_car where car_status = 1");
                                            $stmt->execute();
                                            $users = $stmt->fetchAll();
