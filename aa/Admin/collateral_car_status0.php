...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>ລາຍງານຂໍ້ມູນຫຼັບຊັບຄ້ຳປະກັນ ລົດຈັກ-ລົດໃຫຍ່ ທີ່ມີສະຖານະວ່າງ</title>
   ...
   // Assuming $row is the last generated ID
...
<?php
        ...
        $sql_count_lg_id= mysqli_query($conns, "select count(car_id) from collateral_car");
        $show_count_lg_id = mysqli_fetch_array($sql_count_lg_id);

        $sql_count_la_status0= mysqli_query($conns, "select count(car_id) from collateral_car where car_status = 0");
        $show_count_la_status0 = mysqli_fetch_array($sql_count_la_status0);

        $sql_count_la_status1= mysqli_query($conns, "select count(car_id) from collateral_car where car_status = 1");
        $show_count_la_status1 = mysqli_fetch_array($sql_count_la_status1);

        $sql_count_la_status2= mysqli_query($conns, "select count(car_id) from collateral_car where car_status = 2");
        $show_count_la_status2 = mysqli_fetch_array($sql_count_la_status2);

        $sql_cus_total_expenses = mysqli_query($conns, "select car_pham from collateral_car where car_pham = (select max(car_pham) from collateral_car)");
        $show_cus_total_expenses = mysqli_fetch_array($sql_cus_total_expenses);

        $sql_cus_total_expensesmin = mysqli_query($conns, "select car_pham from collateral_car where car_pham = (select min(car_pham) from collateral_car)");
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            <div class="dashboard_bar">
                                ຫຼັບຊັບຄ້ຳປະກັນ ລົດຈັກ-ລົດໃຫຍ່ ທີ່ມີສະຖານະວ່າງ
                            </div>
                        </div>
        ...
        <div class="content-body ">
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a href="javascript:void(0)"></a>ລາຍງານຂໍ້ມູນຫຼັບຊັບຄ້ຳປະກັນ ລົດຈັກ-ລົດໃຫຍ່ ທີ່ມີສະຖານະວ່າງ</li>
                    </ol>
                </div>
                <!-- row -->
                ...
                <div class="col-xl-3 col-xxl-3 col-sm-6">
                        <a href="collateral_select_car.php">
                    ...
                    <div class="col-xl-3 col-xxl-3 col-sm-6">
                        <a href="collateral_car_status0.php">
                            <div class="card bg-success invoice-card">
                                <div class="card-body d-flex">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-white fs-18">ຫຼັກຊັບຄ້ຳປະກັນສະຖາວ່າງ</span>
                                    </div>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="col-xl-3 col-xxl-3 col-sm-6">
                        <a href="collateral_car_status1.php">
                            <div class="card bg-info invoice-card">
                                <div class="card-body d-flex">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-white fs-18">ຫຼັກຊັບຄ້ຳປະກັນສະຖານະນຳໃຊ້</span>
                                    </div>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="col-xl-3 col-xxl-3 col-sm-6">
                        <a href="collateral_car_status2.php">
                        <div class="card bg-secondary invoice-card">
                            <div class="card-body d-flex">
                                ...
                                <div>
                                    ...
                                    <span class="text-white fs-18">ຫຼັກຊັບຄ້ຳປະກັນທີ່ປິດສັນຍາແລ້ວ</span>
                                </div>
                            </div>
                        </div>
                        </a>
                            ...
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white text-end">
                                        <p class="mb-1 fs-18">ລົດທີ່ມູນຄ້າການປະເມີນຫຼາຍທີ່ສຸດ</p>
                        ...
                        <div style="background: #2980B9;" class="widget-stat card">
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white text-end">
                                        <p class="mb-1 fs-18">ລົດທີ່ມີມູນຄ້າການປະເມີນໜ່ອຍທີ່ສຸດ</p>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">ຕາຕະລາງລາຍລະອຽດຂໍ້ມູນຫຼັບຊັບຄ້ຳປະກັນ ທີ່ດິນ-ທີ່ດິນພ້ອມສິ່ງປູກສ້າງ</h4>
                                <a href="collateral_insert_car.php" style="cursor: pointer;" class="btn me-2 btn-primary"><i class="bi bi-person-plus-fill me-2"></i>ບັນທຶກຫຼັກຊັບຄ້ຳປະກັນ</a>                           
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="example" class="display" style="min-width: 845px">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>ຜູ້ລົງກວດສອບ</th>
                                                <th>ປະເພດຫຼັກຊັບ</th>
                                                <th>ທະບຽນລົດ(Car number)</th>
                                                <th>ເລກຈັກ(Eg number)</th>
                                                <th>ເລກຖັງ(VC number)</th>
                                                <th>ຍີຫໍ່</th>
                                                <th>ສະຖານະ</th>
                                                <th>ເມນູ</th>
                                            </tr>
                                        ...
                                        <tbody>
                                            <?php
                                            $stmt = $conn->query("select * from collateral_car where car_status = 0");
                                            $stmt->execute();
                                            $users = $stmt->fetchAll();
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row['car_running_id']; ?></td>
                                                    <td><?php echo $row['car_check_name']; ?></td>
                                                    <td><?php echo $row['car_type']; ?></td>
                                                    <td><?php echo $row['car_number']; ?></td>
                                                    <td><?php echo $row['car_eg_number']; ?></td>
                                                    <td><?php echo $row['car_t_number']; ?></td>
