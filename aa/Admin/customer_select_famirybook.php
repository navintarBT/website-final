...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>ລາຍງານຂໍ້ມູນປື້ມສຳມະໂນຄົວ</title>
...
<body>
    ...
    $sql_count_cus_id = mysqli_query($conns, "select count(cus_id) from customers where cus_familybook_id <> 0");
    $show_cus_familybook_id = mysqli_fetch_array($sql_count_cus_id);
    ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:void(0)">ລາຍງານຂໍ້ມູນປຶ້ມສຳມະໂນຄົວ</a></li>
                        </ol>
                    </div>
                    <!-- row -->
                    ...
                    <div class="row invoice-card-row">
                        <div style="cursor: pointer;" class="col-xl-12 col-xxl-3 col-sm-6">
                            <div class="card bg-secondary invoice-card">
                                <div class="card-body d-flex">
                                    ...
                                    <div>
                                        <h2 class="text-white invoice-num"><?php echo $show_cus_familybook_id[0] ?> ລາຍການ</h2>
                                        <span class="text-white fs-18">ຈຳນວນປຶ້ມສຳມະໂນຄົວ</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <table id="example" class="display" style="min-width: 845px">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>ລະຫັດປຶ້ມສຳມະໂນຄົວ</th>
                                                    <th>ລະຫັດແຂວງທີ່ອອກປຶ້ມ</th>
                                                    <th>ວັນທີ່ອອກປື້ມ</th>
                                                    <th>ສະຖານະ</th>
                                                    <th>ເມນູ</th>
                                                </tr>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php
                                                            if ($row['cus_familybook_id'] == "0") {
                                                                echo "ບໍ່ມີຂໍ້ມູນ!";
                                                            } else {
                                                                echo $row['cus_familybook_id'];
                                                            }
                                                            ?></td>
                                                        <td><?php
                                                            if ($row['cus_familybook_pv_code'] == "") {
                                                                echo "ບໍ່ມີຂໍ້ມູນ!";
                                                            } else {
                                                                echo $row['cus_familybook_pv_code'];
                                                            }
                                                            ?></td>
                                                        <td><?php
                                                            if ($row['cus_familybook_issue_date'] == "0000-00-00") {
                                                                echo "ບໍ່ມີຂໍ້ມູນ!";
                                                            } else {
                                                                echo $row['cus_familybook_issue_date'];
                                                            }
                                                            ?></td>
                                                        ...
                                                        <td>
                                                            <div class="btn-group dropstart mb-1">
                                                                ...
                                                                <div style="background: #FDFEFE;" class="dropdown-menu">
                                                                    ...
                                                                    <hr>
                                                                    <a class="dropdown-item button_edit" href="customer_update_famirybook.php?id=<?php echo $row['cus_id']; ?> ">ແກ້ໄຂຂໍ້ມູນ</a>
                ...
                Swal.fire({
                    ...
                    preConfirm: function() {
                        return new Promise(function(resolve) {
                            $.ajax({
                                    url: 'customer_select_famirybook.php',
                                    type: 'GET',
                                    data: 'delete=' + userId,
                                })
                                .done(function() {
                                    Swal.fire({
                                        ...
                                        document.location.href = 'customer_select_famirybook.php';
                                    })
                                })
                                .fail(function() {
