...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>ລາຍງານຂໍ້ມູນຜູ້ຄ້ຳປະກັນ</title>
        ...
        <div class="content-body ">
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a href="javascript:void(0)"></a>ຜູ້ຄ້ຳປະກັນ</li>
                        <li class="breadcrumb-item"><a href="javascript:void(0)">ລາຍງານຂໍ້ມູນຜູ້ຄ້ຳປະກັນ</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0)">ລາຍງານຂໍ້ມູນເພີ່ມເຕີມຜູ້ຄ້ຳປະກັນ</a></li>
                    </ol>
                </div>
                <!-- row -->
                <form action="" class="needs-validation" novalidate="" method="post" enctype="multipart/form-data">
                    ...
                    if (isset($_GET['id'])) {
                        $id = $_GET['id'];
                        $stmt = $conn->query("SELECT * FROM guarantor WHERE cus_id = $id");
                        $stmt->execute();
                        $data = $stmt->fetch();
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input style="border: none; font-size: 18px; margin-left: -1.3rem;" type="text" value="<?php echo $data['gt_doc_name'] ?>" class="form-control gt_doc_name" name="gt_doc_name" id="validationCustom01" required="" placeholder="ປ້ອນຊື່ເອກະສານ...">
                                                </div>
                                                <label class="col-form-label" for="validationCustom06">ຟາຍເອກະສານ
                                                </label>

                                                <a href="guarantor_docs/<?php echo $data['gt_doc_file']; ?>">
                                        ...
                                        <div class="row justify-content-center h-100 align-items-center">
                                            <div class="col-md-7">
                                                <div class="form-input-content text-center error-page">
                                                    <h3 style="font-size: 50px;" class="error-text fw-bold">ບໍ່ມີຜູ້ຄ້ຳປະກັນ</h3>
                                                    <h4><i class="fa fa-exclamation-triangle text-warning"></i> ກາລຸນາບັນທຶກຂໍ້ມູນຜູ້ຄ້ຳປະກັນກ່ອນ</h4>
                                                    <div>
