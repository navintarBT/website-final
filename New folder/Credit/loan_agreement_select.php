...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>ລາຍງານຂໍ້ມູນການເຮັກສັນຍາ</title>
...
<body>
    ...
    $sql_cus_total_expenses = mysqli_query($conns, "select lg_capital_plus_interest from loan_agreement where lg_capital_plus_interest = (select max(lg_capital_plus_interest) from loan_agreement)");
    ...
    $sql_cus_total_expensesmin = mysqli_query($conns, "select lg_capital_plus_interest from loan_agreement where lg_capital_plus_interest = (select min(lg_capital_plus_interest) from loan_agreement)");
                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:void(0)">ລາຍງານຂໍ້ມູນການເຮັກສັນຍາ</a></li>
                        </ol>
                    </div>
                    <!-- row -->
                        ...
                        <div class="col-xl-4 col-xxl-3 col-sm-6">
                            <div class="card bg-warning invoice-card">
                                <div class="card-body d-flex">
                                    ...
                                    <div>
                                        <h2 class="text-white invoice-num"><?php echo $show_count_lg_id[0] ?> ລາຍການ</h2>
                                        <span class="text-white fs-18">ສັນຍາທີ່ກຳລັງດຳເນິນການ</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">ຕາຕະລາງລາຍລະອຽດຂໍ້ມູນການເຮັດສັນຍາ</h4>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example" class="display" style="min-width: 845px">
                                            ...
                                            <tbody>
                                                <?php
                                                $stmt = $conn->query("SELECT * FROM loan_agreement");
                                                $stmt->execute();
                                                $users = $stmt->fetchAll();
