...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>ແບບຟອມບັນທຶກຂໍ້ມູນຜູ້ຄຳປະກັນ</title>
    ...
    $query = "SELECT count(gt_id) FROM guarantor ORDER BY gt_id DESC LIMIT 1; ";
    ...
    if (isset($_POST['submit'])) {
        ...
        $upload = $_FILES['gt_doc_file']['name'];
        ...
        if ($upload != '') {
            ...
            if ($typefile == '.pdf') {
                ...
                move_uploaded_file($_FILES['gt_doc_file']['tmp_name'], $path_copy);
                ...
                $sql = $conn->prepare("INSERT INTO guarantor(gt_runing_id,gt_flname,gt_age,gt_nationality,gt_job,gt_vill,gt_dis,gt_pro,gt_card_id,gt_date_card,gt_tel,gt_doc_name,gt_doc_file,gt_date_in,gt_time_in,gt_satatus,cus_id,cus_fname,cus_runing,user_id) 
                VALUES(:gt_runing_id,:gt_flname,:gt_age,:gt_nationality,:gt_job,:gt_vill,:gt_dis,:gt_pro,:gt_card_id,:gt_date_card,:gt_tel,:gt_doc_name,'$newname',curdate(),curtime(),:gt_satatus,:cus_id,:cus_fname,:cus_runing,:user_id)");
                                        ...
                                        Swal.fire({
                                          ...
                                          willClose: () => {
                                            ...
                                            Swal.fire({
                                                ...
                                                showConfirmButton: true,
                                                preConfirm: function() {
                                                    document.location.href = 'guarantor_insert.php';
                                                }
                                            });
                                        })
                                    })
        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">ຂໍ້ມູນຜູ້ຄຳປະກັນ</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0)">ບັນທຶກຂໍ້ມູນຜູ້ຄຳປະກັນ</a></li>
                    </ol>
                </div>
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">ຟອມບັນທຶກຂໍ້ມູນຜູ້ຄຳປະກັນ</h4>
                            </div>
                            <div class="card-body">
                                                            ...
                                                            <div class="mb-1 row">
                                                                ...
                                                                <label class="col-form-label" for="validationCustom06">ລະຫັດຜູ້ຄ້ຳປະກັນ
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input style="background: #e8f0fe;" type="text" class="form-control gt_runing_id" id="validationCustom01" value="<?php echo $number ?>" required="" name="gt_runing_id" readonly>
                                                                    </div>
                                                                    ...
                                                                    <div class="input-group">
                                                                        <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                                        <input type="text" class="form-control gt_flname" id="validationCustom01" placeholder="ປ້ອນຊື່ ແລະ ນາມສະກຸນ  ຜູ້ຄ້ຳປະກັນ..." required="" name="gt_flname">
                                                                    </div>
                                                                </div>
                                                                <div class="col-xl-3">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                                        <input type="text" class="form-control gt_age" id="validationCustom01" placeholder="ປ້ອນອາຍຸ..." required="" name="gt_age">
                                                                    </div>
                                                                    ...
                                                                    <div class="input-group">
                                                                        <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                                        <input type="text" class="form-control gt_nationality" id="validationCustom01" placeholder="ປ້ອນສັນຊາດ..." required="" name="gt_nationality">
                                                                    </div>
                                                                    ...
                                                                    <div class="input-group">
                                                                        <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                                        <input type="text" class="form-control gt_job" id="validationCustom01" placeholder="ປ້ອນອາຊີບ..." required="" name="gt_job">
                                                                    </div>
                                                                    ...
                                                                    <div class="input-group">
                                                                        <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                                        <input type="text" class="form-control gt_vill" id="validationCustom01" placeholder="ປ້ອນບ້ານຢູ່ປັດຈຸບັນ..." required="" name="gt_vill">
                                                                    </div>
                                                                </div>
                                                                <div class="col-xl-3">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                                        <input type="text" class="form-control gt_dis" id="validationCustom01" placeholder="ປ້ອນເມືອງ..." required="" name="gt_dis">
                                                                    </div>
                                                                    ...
                                                                    <div class="input-group">
                                                                        <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                                        <input type="text" class="form-control gt_pro" id="validationCustom01" placeholder="ປ້ອນແຂວງ..." required="" name="gt_pro">
                                                                    </div>
                                                                    ...
                                                                    <div class="input-group">
                                                                        <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                                        <input type="text" class="form-control gt_card_id" id="validationCustom01" placeholder="ປ້ອນຖືບັດປະຈຳຕົວເລກທີ່..." required="" name="gt_card_id">
                                                                    </div>
                                                                    ...
                                                                    <div class="input-group">
                                                                        <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                                        <input type="date" class="form-control gt_date_card" id="validationCustom01" placeholder="ລົງວັນທີ..." required="" name="gt_date_card">
                                                                    </div>
                                                                </div>
                                                                <div class="col-xl-3">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                                        <input type="text" class="form-control gt_tel" id="validationCustom01" placeholder="ປ້ອນເບີໂທ..." required="" name="gt_tel">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                        <input type="text" class="form-control gt_doc_name" name="gt_doc_name" id="validationCustom01" required="" placeholder="ປ້ອນຊື່ເອກະສານ...">
                                                    </div>
                                                    ...
                                                    <label for="images" class="drop-container">
                                                        ...
                                                        <br>
                                                        <input type="file" class="gt_doc_file" id="images" name="gt_doc_file" accept="application/pdf" required="">
                                                    </label>
