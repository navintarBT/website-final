                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:void(0)">ຢືນຢັນການປ່ອນສິນເຊື່ອ</a></li>
                        </ol>
                    </div>
                    <!-- row -->
                                                        ...
                                                        <td>
                                                            <div class="btn-group dropstart mb-1">
                                                                ...
                                                                <div style="background: #FDFEFE;" class="dropdown-menu">
                                                                    ...
                                                                    <a class="dropdown-item" href="credit_release_doc_confirm.php?id=<?php echo $row['cr_id']; ?>">ຢືນຢັນການປ່ອນສິນເຊື່ອ</a>
                                                                    <hr>
